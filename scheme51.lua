...
" );
 ...
 ignore(_makeS45lambda)_map = setmetatable({args={symbol('f'),{symbol('x'),scm_nil}},doc="Map the procedure ,f over the list ,x, collecting the results in a\
   new list that doesn't share any structure with ,x."}, { __call = function(_S35S46903 ,  _f ,  _x  )
 ...
 return {_makeS45lambda(var(_args, "args"),  var(_body, "body") ), var(_vals, "vals")}
  ...
  predicate."}, { __call = function(_S35S46905 ,  _x ,  _xs  )
 ...
 ignore(_member)_append = setmetatable({args={symbol('xs'),{symbol('ys'),scm_nil}},doc="Append the list ,xs with the list ,ys, such that the result shares\
  structure with ,ys."}, { __call = function(_S35S46908 ,  _xs ,  _ys  )
 if (function(_S35S46910)
 if _S35S46910 then
 return true else
 ...
 ignore(_append)_expandS47helper = setmetatable({args={symbol('shadow'),{symbol('s'),scm_nil}},doc="Expand the expression ,s, without considering the symbols in ,shadow\
  as possibly macros."}, { __call = function(_S35S46911 ,  _shadow ,  _s  )
 if (function(_S35S46913)
 if _S35S46913 then
 return (function(_S35S46914)
 if _S35S46914 then
 ...
 end)(var(_pairS63, "pair?")(_s )) then if _eqS63((_s)[1],  symbol('quote') ) then return _s else if (function(_S35S46917)
 if _S35S46917 then
 return _symbolS63(_cadr(_s ) ) else
 return false
 end
 end)(_eqS63((_s)[1],  keyword('prim') )) then return _cadr(_s ) else if _eqS63((_s)[1],  symbol('unquote') ) then return var(_eval, "eval")(_cadr(_s ) ) else if _eqS63((_s)[1],  symbol('lambda') ) then return _makeS45lambda(_cadr(_s ),  _expandS47helper(_append((function(_S35S46920)
 if _S35S46920 then
 ...
 ignore(_expandS47helper)_expand = setmetatable({args={symbol('s'),scm_nil},doc="Macro-expand the expression ,s"}, { __call = function(_S35S46923 ,  _s  )
 return _expandS47helper(scm_nil,  var(_s, "s") )
 end });
 ignore(_expand)_andS45expander = setmetatable({args={symbol('macro-arguments'),scm_nil},doc="Macro expander for 'and expressions."}, { __call = function(_S35S46924 ,  _macroS45arguments  )
 ...
 ignore(_andS45expander)_orS45expander = setmetatable({args={symbol('macro-arguments'),scm_nil},doc="Macro expander for 'or expressions."}, { __call = function(_S35S46927 ,  _macroS45arguments  )
 ...
 ignore(_orS45expander)ignore(_pushS45macroS33(symbol('and'),  _andS45expander ))ignore(_pushS45macroS33(symbol('or'),  _orS45expander ))_quasiquoteS47helper = setmetatable({args={symbol('do-quote'),{symbol('expr'),scm_nil}},doc="Macro expander for quasiquote expressions."}, { __call = function(_S35S46929 ,  _doS45quote ,  _expr  )
 if (function(_S35S46931)
 if _S35S46931 then
 return _S61(symbol('unquote'),  (var(_expr, "expr"))[1] ) else
 return false
 end
 end)(var(_pairS63, "pair?")(_expr )) then return _cadr(_expr ) else if _pairS63(_expr ) then if (function(_S35S46934)
 if _S35S46934 then
 ...
 end) ))ignore(_pushS45macroS33(symbol('cond'),  (function(_S35S46942  )
 ...
 return _expand(var(_cases, "cases") )
  ...
  If no parameters are given in the call, the stored value is returned."}, { __call = function(_S35S46948 ,  ...)
 local _initval = list(...);
 ...
 end)((function(_S35S46945  )
 if var(_S35S46945, "#.945") then return _S35S46945 else return (function(_S35S46946  )
 if var(_S35S46946, "#.946") then return _S35S46946 else return false end
 end)(false ) end
 end)((var(_initval, "initval"))[1] ) )
 end });
 ignore(_makeS45parameter)ignore(_pushS45macroS33(symbol('parameterise'),  (function(_S35S46952  )
 ...
 return setmetatable({args=symbol('args'),doc="Make a hash table with the associations given as pairs in ,args."}, { __call = function(_S35S46956 ,  ...)
 local _args = list(...);
 local _table;
 ...
 ignore(_makeS45hashS45table)_length = setmetatable({args={symbol('l'),symbol('a')},doc="Compute the length of the list ,l. Optionally, use ('car ,a) as the\
  length of the empty list. (Leave ,a empty for 0)."}, { __call = function(_S35S46957 ,  _l ,  ...)
 local _a = list(...);
 ...
 ignore(_safe)ignore(_pushS45macroS33(symbol('check-parameter'),  (function(_S35S46961  )
 ...
 return {symbol('if'), {var(_c, "c"), {false, {{symbol('begin'), var(_b, "b")}, scm_nil}}}}
   ...
   expression."}, { __call = function(_S35S46966 ,  _f  )
 ...
 ignore(_call)_callS42 = setmetatable({args={symbol('obj'),{symbol('meth'),symbol('args')}},doc="Call the method ,meth on the object ,obj, giving the ,args as\
  variadic arguments."}, { __call = function(_S35S46969 ,  _obj ,  _meth ,  ...)
 local _args = list(...);
 return var(_apply, "apply")(var(_hashS45ref, "hash-ref")(var(_obj, "obj"),  var(_meth, "meth") ),  var(_args, "args") )
 end });
 ignore(_callS42)ignore((function(_S35S46970)
 if _S35S46970 then
 return (function()
 ...
 ignore(_S42caseS45void)ignore(_pushS45macroS33(symbol('*case'),  (function(_S35S46973  )
 ...
 end)() else if (function(_S35S46997  )
 ...
 if var(_S35S461001, "#.1001") then return _S35S461001 else return (function(_S35S461002  )
 if var(_S35S461002, "#.1002") then return _S35S461002 else return false end
 end)((function(_S35S461012)
 if _S35S461012 then
 ...
 end)() else if (function(_S35S461015)
 if _S35S461015 then
 return (function(_S35S461016)
 if _S35S461016 then
 return (function(_S35S461017)
 if _S35S461017 then
 ...
 end) ))ignore(_pushS45macroS33(symbol('case!'),  (function(_S35S461021  )
 return var(_apply, "apply")((function(_expr ,  _case1 ,  ...)
 local _cases = list(...);
 ...
 end) ))ignore(_pushS45macroS33(symbol('case-lambda'),  (function(_S35S461022  )
 return var(_apply, "apply")((function(...)
 local _args = list(...);
 local _name;
 ...
 if _caseS45pairS63(var(_S35S461032, "#.1032") ) then return (function(_docs  )
 return (function(_S35S461036  )
 if _caseS45pairS63((_S35S461032)[2] ) then return (function(_case1  )
 ...
 end)() else return var(_S35S461033, "#.1033")() end
 end)(((_S35S461032)[2])[2] )
 end)(((_S35S461032)[2])[1] ) else return var(_S35S461036, "#.1036")() end
 end)((function()
 return var(_S35S461035, "#.1035")()
 end) )
 end)((_S35S461032)[1] ) else return var(_S35S461035, "#.1035")() end
 end)((function()
 return var(_S35S461033, "#.1033")()
 end) )
 end)((function()
 return (function(_S35S461034  )
 if _caseS45pairS63(var(_S35S461032, "#.1032") ) then return (function(_case1  )
 return (function(_cases  )
 return (function()
 return {symbol('lambda'), {var(_name, "name"), {{symbol('case!'), {_name, {var(_case1, "case1"), var(_cases, "cases")}}}, scm_nil}}}
 end)()
 end)((_S35S461032)[2] )
 end)((_S35S461032)[1] ) else return var(_S35S461034, "#.1034")() end
 end)((function()
 return false
 end) )
 end) )
 end)(var(_args, "args") )
 end),  var(_S35S461022, "#.1022") )
 end) ))ignore(_pushS45macroS33(symbol('let-values'),  (function(_S35S461041  )
 return var(_apply, "apply")((function(...)
 local _S35S461056 = list(...);
 return (function(_S35S461057  )
 return (function(_S35S461058  )
 if _caseS45pairS63(var(_S35S461057, "#.1057") ) then if _S61(scm_nil,  (_S35S461057)[1] ) then return (function(_body  )
 return (function()
 return {symbol('begin'), var(_body, "body")}
 end)()
 end)((_S35S461057)[2] ) else return var(_S35S461058, "#.1058")() end else return _S35S461058() end
 end)((function()
 return (function(_S35S461059  )
 if _caseS45pairS63(var(_S35S461057, "#.1057") ) then return (function(_S35S461060  )
 if _caseS45pairS63((_S35S461057)[1] ) then return (function(_S35S461061  )
 if _caseS45pairS63(((_S35S461057)[1])[1] ) then return (function(_names  )
 return (function(_S35S461062  )
 if _caseS45pairS63((((_S35S461057)[1])[1])[2] ) then return (function(_expr  )
 if _S61(scm_nil,  ((((_S35S461057)[1])[1])[2])[2] ) then return (function(_rest  )
 ...
 end)(((_S35S461057)[1])[2] ) else return var(_S35S461062, "#.1062")() end
 end)(((((_S35S461057)[1])[1])[2])[1] ) else return var(_S35S461062, "#.1062")() end
 end)((function()
 return var(_S35S461061, "#.1061")()
 end) )
 end)((((_S35S461057)[1])[1])[1] ) else return var(_S35S461061, "#.1061")() end
 end)((function()
 return var(_S35S461060, "#.1060")()
 end) ) else return var(_S35S461060, "#.1060")() end
 end)((function()
 return var(_S35S461059, "#.1059")()
 end) ) else return var(_S35S461059, "#.1059")() end
 end)((function()
 return var(_error, "error")("no matching case for ",  var(_S35S461056, "#.1056"),  " in ",  {{{scm_nil,symbol('body')},{{symbol('quasiquote'),{{symbol('begin'),{symbol('unquote'),{symbol('body'),scm_nil}}},scm_nil}},scm_nil}},{{{{{symbol('names'),{symbol('expr'),scm_nil}},symbol('rest')},symbol('body')},{{symbol('quasiquote'),{{symbol('call-with-values'),{{symbol('lambda'),{scm_nil,{{symbol('unquote'),{symbol('expr'),scm_nil}},scm_nil}}},{{symbol('lambda'),{{symbol('unquote'),{symbol('names'),scm_nil}},{{symbol('let-values'),{{symbol('unquote'),{symbol('rest'),scm_nil}},{symbol('unquote'),{symbol('body'),scm_nil}}}},scm_nil}}},scm_nil}}},scm_nil}},scm_nil}},scm_nil}} )
 end) )
 end) )
 end)(var(_S35S461056, "#.1056") )
 end),  var(_S35S461041, "#.1041") )
 end) ))ignore(_pushS45macroS33(symbol('let'),  (function(_S35S461070  )
 return var(_apply, "apply")((function(...)
 local _S35S461098 = list(...);
 return (function(_S35S461099  )
 return (function(_S35S461100  )
 return (function(_S35S461106  )
 if _caseS45pairS63(var(_S35S461099, "#.1099") ) then return (function(_name  )
 return (function(_S35S461107  )
 if _caseS45pairS63((_S35S461099)[2] ) then return (function(_S35S461108  )
 if _caseS45pairS63(((_S35S461099)[2])[1] ) then return (function(_S35S461109  )
 if _caseS45pairS63((((_S35S461099)[2])[1])[1] ) then return (function(_name1  )
 return (function(_S35S461110  )
 if _caseS45pairS63(((((_S35S461099)[2])[1])[1])[2] ) then return (function(_init1  )
 if _S61(scm_nil,  (((((_S35S461099)[2])[1])[1])[2])[2] ) then return (function(_vars  )
 return (function(_body  )
 ...
 end)((((_S35S461099)[2])[1])[2] ) else return var(_S35S461110, "#.1110")() end
 end)((((((_S35S461099)[2])[1])[1])[2])[1] ) else return var(_S35S461110, "#.1110")() end
 end)((function()
 return var(_S35S461109, "#.1109")()
 end) )
 end)(((((_S35S461099)[2])[1])[1])[1] ) else return var(_S35S461109, "#.1109")() end
 end)((function()
 return var(_S35S461108, "#.1108")()
 end) ) else return var(_S35S461108, "#.1108")() end
 end)((function()
 ...
 end)((_S35S461099)[1] ) else return var(_S35S461106, "#.1106")() end
 end)((function()
 return var(_S35S461100, "#.1100")()
 end) )
 end)((function()
 return (function(_S35S461101  )
 if _caseS45pairS63(var(_S35S461099, "#.1099") ) then return (function(_S35S461103  )
 if _caseS45pairS63((_S35S461099)[1] ) then return (function(_S35S461104  )
 if _caseS45pairS63(((_S35S461099)[1])[1] ) then return (function(_name1  )
 return (function(_S35S461105  )
 if _caseS45pairS63((((_S35S461099)[1])[1])[2] ) then return (function(_init1  )
 if _S61(scm_nil,  ((((_S35S461099)[1])[1])[2])[2] ) then return (function(_vars  )
 return (function(_body  )
 return (function()
 return {{symbol('lambda'), {{var(_name1, "name1"), _map(var(_car, "car"),  var(_vars, "vars") )}, var(_body, "body")}}, {var(_init1, "init1"), _map(_cadr,  _vars )}}
 end)()
 end)((_S35S461099)[2] )
 end)(((_S35S461099)[1])[2] ) else return var(_S35S461105, "#.1105")() end
 end)(((((_S35S461099)[1])[1])[2])[1] ) else return var(_S35S461105, "#.1105")() end
 end)((function()
 return var(_S35S461104, "#.1104")()
 end) )
 end)((((_S35S461099)[1])[1])[1] ) else return var(_S35S461104, "#.1104")() end
 end)((function()
 return var(_S35S461103, "#.1103")()
 end) ) else return var(_S35S461103, "#.1103")() end
 end)((function()
 return var(_S35S461101, "#.1101")()
 end) ) else return var(_S35S461101, "#.1101")() end
 end)((function()
 return (function(_S35S461102  )
 if _caseS45pairS63(var(_S35S461099, "#.1099") ) then if _S61(scm_nil,  (_S35S461099)[1] ) then return (function(_body  )
 return (function()
 return {symbol('begin'), var(_body, "body")}
 end)()
 end)((_S35S461099)[2] ) else return var(_S35S461102, "#.1102")() end else return _S35S461102() end
 end)((function()
 return var(_error, "error")("no matching case for ",  var(_S35S461098, "#.1098"),  " in ",  {{{{symbol('name'),{{{symbol('name1'),{symbol('init1'),scm_nil}},symbol('vars')},symbol('body')}},{keyword('when'),{{symbol('symbol?'),{symbol('name'),scm_nil}},scm_nil}}},{{symbol('quasiquote'),{{symbol('begin'),{{symbol('define'),{{symbol('unquote'),{symbol('name'),scm_nil}},{{symbol('lambda'),{{{symbol('unquote'),{symbol('name1'),scm_nil}},{symbol('unquote'),{{symbol('map'),{symbol('car'),{symbol('vars'),scm_nil}}},scm_nil}}},{symbol('unquote'),{symbol('body'),scm_nil}}}},scm_nil}}},{{{symbol('unquote'),{symbol('name'),scm_nil}},{{symbol('unquote'),{symbol('init1'),scm_nil}},{symbol('unquote'),{{symbol('map'),{symbol('cadr'),{symbol('vars'),scm_nil}}},scm_nil}}}},scm_nil}}},scm_nil}},scm_nil}},{{{{{symbol('name1'),{symbol('init1'),scm_nil}},symbol('vars')},symbol('body')},{{symbol('quasiquote'),{{{symbol('lambda'),{{{symbol('unquote'),{symbol('name1'),scm_nil}},{symbol('unquote'),{{symbol('map'),{symbol('car'),{symbol('vars'),scm_nil}}},scm_nil}}},{symbol('unquote'),{symbol('body'),scm_nil}}}},{{symbol('unquote'),{symbol('init1'),scm_nil}},{symbol('unquote'),{{symbol('map'),{symbol('cadr'),{symbol('vars'),scm_nil}}},scm_nil}}}},scm_nil}},scm_nil}},{{{scm_nil,symbol('body')},{{symbol('quasiquote'),{{symbol('begin'),{symbol('unquote'),{symbol('body'),scm_nil}}},scm_nil}},scm_nil}},scm_nil}}} )
 end) )
 end) )
 end) )
 end)(var(_S35S461098, "#.1098") )
 end),  var(_S35S461070, "#.1070") )
 end) ))ignore(_pushS45macroS33(symbol('letrec'),  (function(_S35S461125  )
 return var(_apply, "apply")((function(_vars ,  ...)
 local _body = list(...);
 ...
 end) ))ignore(_pushS45macroS33(symbol('let-syntax'),  (function(_S35S461126  )
 return var(_apply, "apply")((function()
 _go = (function(...)
 local _S35S461141 = list(...);
 return (function(_S35S461142  )
 return (function(_S35S461143  )
 if _caseS45pairS63(var(_S35S461142, "#.1142") ) then return (function(_S35S461145  )
 if _caseS45pairS63((_S35S461142)[1] ) then return (function(_S35S461146  )
 if _caseS45pairS63(((_S35S461142)[1])[1] ) then return (function(_var  )
 return (function(_S35S461147  )
 if _caseS45pairS63((((_S35S461142)[1])[1])[2] ) then return (function(_macro  )
 if _S61(scm_nil,  ((((_S35S461142)[1])[1])[2])[2] ) then return (function(_vars  )
 return (function(_body  )
 return (function()
 local _saved;
 ...
 end)(((_S35S461142)[1])[2] ) else return var(_S35S461147, "#.1147")() end
 end)(((((_S35S461142)[1])[1])[2])[1] ) else return var(_S35S461147, "#.1147")() end
 end)((function()
 return var(_S35S461146, "#.1146")()
 end) )
 end)((((_S35S461142)[1])[1])[1] ) else return var(_S35S461146, "#.1146")() end
 end)((function()
 return var(_S35S461145, "#.1145")()
 end) ) else return var(_S35S461145, "#.1145")() end
 end)((function()
 return var(_S35S461143, "#.1143")()
 end) ) else return var(_S35S461143, "#.1143")() end
 end)((function()
 return (function(_S35S461144  )
 if _caseS45pairS63(var(_S35S461142, "#.1142") ) then if _S61(scm_nil,  (_S35S461142)[1] ) then return (function(_body  )
 return (function()
 return {symbol('begin'), _expand(var(_body, "body") )}
 end)()
 end)((_S35S461142)[2] ) else return var(_S35S461144, "#.1144")() end else return _S35S461144() end
 end)((function()
 return var(_error, "error")("no matching case for ",  var(_S35S461141, "#.1141"),  " in ",  {{{{{symbol('var'),{symbol('macro'),scm_nil}},symbol('vars')},symbol('body')},{{symbol('define'),{symbol('saved'),{{symbol('lookup-macro-in'),{symbol('var'),{symbol('macros'),scm_nil}}},scm_nil}}},{{symbol('push-macro!'),{symbol('var'),{{symbol('eval'),{symbol('macro'),scm_nil}},scm_nil}}},{{symbol('let'),{{{symbol('b'),{{symbol('apply'),{symbol('go'),{{symbol('cons'),{symbol('vars'),{symbol('body'),scm_nil}}},scm_nil}}},scm_nil}},scm_nil},{{symbol('push-macro!'),{symbol('var'),{symbol('saved'),scm_nil}}},{symbol('b'),scm_nil}}}},scm_nil}}}},{{{scm_nil,symbol('body')},{{symbol('quasiquote'),{{symbol('begin'),{symbol('unquote'),{{symbol('expand'),{symbol('body'),scm_nil}},scm_nil}}},scm_nil}},scm_nil}},scm_nil}} )
 end) )
 end) )
 end)(var(_S35S461141, "#.1141") )
 end);
 return _go
 end)(),  var(_S35S461126, "#.1126") )
 end) ))ignore(_pushS45macroS33(symbol('let*'),  (function(_S35S461155  )
 return var(_apply, "apply")((function(...)
 local _S35S461170 = list(...);
 return (function(_S35S461171  )
 return (function(_S35S461172  )
 if _caseS45pairS63(var(_S35S461171, "#.1171") ) then if _S61(scm_nil,  (_S35S461171)[1] ) then return (function(_body  )
 return (function()
 return {symbol('begin'), var(_body, "body")}
 end)()
 end)((_S35S461171)[2] ) else return var(_S35S461172, "#.1172")() end else return _S35S461172() end
 end)((function()
 return (function(_S35S461173  )
 if _caseS45pairS63(var(_S35S461171, "#.1171") ) then return (function(_S35S461174  )
 if _caseS45pairS63((_S35S461171)[1] ) then return (function(_S35S461175  )
 if _caseS45pairS63(((_S35S461171)[1])[1] ) then return (function(_var1  )
 return (function(_S35S461176  )
 if _caseS45pairS63((((_S35S461171)[1])[1])[2] ) then return (function(_exp1  )
 if _S61(scm_nil,  ((((_S35S461171)[1])[1])[2])[2] ) then return (function(_vars  )
 return (function(_body  )
 return (function()
 return {{symbol('lambda'), {{var(_var1, "var1"), scm_nil}, {{symbol('letrec'), {var(_vars, "vars"), var(_body, "body")}}, scm_nil}}}, {var(_exp1, "exp1"), scm_nil}}
 end)()
 end)((_S35S461171)[2] )
 end)(((_S35S461171)[1])[2] ) else return var(_S35S461176, "#.1176")() end
 end)(((((_S35S461171)[1])[1])[2])[1] ) else return var(_S35S461176, "#.1176")() end
 end)((function()
 return var(_S35S461175, "#.1175")()
 end) )
 end)((((_S35S461171)[1])[1])[1] ) else return var(_S35S461175, "#.1175")() end
 end)((function()
 return var(_S35S461174, "#.1174")()
 end) ) else return var(_S35S461174, "#.1174")() end
 end)((function()
 return var(_S35S461173, "#.1173")()
 end) ) else return var(_S35S461173, "#.1173")() end
 end)((function()
 return var(_error, "error")("no matching case for ",  var(_S35S461170, "#.1170"),  " in ",  {{{scm_nil,symbol('body')},{{symbol('quasiquote'),{{symbol('begin'),{symbol('unquote'),{symbol('body'),scm_nil}}},scm_nil}},scm_nil}},{{{{{symbol('var1'),{symbol('exp1'),scm_nil}},symbol('vars')},symbol('body')},{{symbol('quasiquote'),{{{symbol('lambda'),{{{symbol('unquote'),{symbol('var1'),scm_nil}},scm_nil},{{symbol('letrec'),{{symbol('unquote'),{symbol('vars'),scm_nil}},{symbol('unquote'),{symbol('body'),scm_nil}}}},scm_nil}}},{{symbol('unquote'),{symbol('exp1'),scm_nil}},scm_nil}},scm_nil}},scm_nil}},scm_nil}} )
 end) )
 end) )
 end)(var(_S35S461170, "#.1170") )
 end),  var(_S35S461155, "#.1155") )
 end) ))_max = setmetatable({args=symbol('#.1184'),doc="Return the maximum of the given arguments."}, { __call = function(_S35S461191 ,  ...)
 local _S35S461184 = list(...);
 return (function(_S35S461185  )
 return (function(_S35S461186  )
 if _caseS45pairS63(var(_S35S461185, "#.1185") ) then return (function(_x  )
 if _S61(scm_nil,  (_S35S461185)[2] ) then return (function()
 return var(_x, "x")
 end)() else return var(_S35S461186, "#.1186")() end
 end)((_S35S461185)[1] ) else return var(_S35S461186, "#.1186")() end
 end)((function()
 return (function(_S35S461187  )
 if _caseS45pairS63(var(_S35S461185, "#.1185") ) then return (function(_x  )
 return (function(_S35S461190  )
 if _caseS45pairS63((_S35S461185)[2] ) then return (function(_y  )
 if _S61(scm_nil,  ((_S35S461185)[2])[2] ) then return (function()
 if var(_S62, ">")(var(_x, "x"),  var(_y, "y") ) then return _x else return _y end
 end)() else return var(_S35S461190, "#.1190")() end
 end)(((_S35S461185)[2])[1] ) else return var(_S35S461190, "#.1190")() end
 end)((function()
 return var(_S35S461187, "#.1187")()
 end) )
 end)((_S35S461185)[1] ) else return var(_S35S461187, "#.1187")() end
 end)((function()
 ...
 end)(((_S35S461185)[2])[1] ) else return var(_S35S461189, "#.1189")() end
 end)((function()
 return var(_S35S461188, "#.1188")()
 end) )
 end)((_S35S461185)[1] ) else return var(_S35S461188, "#.1188")() end
 end)((function()
 return var(_error, "error")("no matching case for ",  var(_S35S461184, "#.1184"),  " in ",  {{{symbol('x'),scm_nil},{symbol('x'),scm_nil}},{{{symbol('x'),{symbol('y'),scm_nil}},{{symbol('if'),{{symbol('>'),{symbol('x'),{symbol('y'),scm_nil}}},{symbol('x'),{symbol('y'),scm_nil}}}},scm_nil}},{{{symbol('x'),{symbol('y'),symbol('z')}},{{symbol('if'),{{symbol('>'),{symbol('x'),{symbol('y'),scm_nil}}},{{symbol('apply'),{symbol('max'),{{symbol('cons'),{symbol('x'),{symbol('z'),scm_nil}}},scm_nil}}},{{symbol('apply'),{symbol('max'),{{symbol('cons'),{symbol('y'),{symbol('z'),scm_nil}}},scm_nil}}},scm_nil}}}},scm_nil}},scm_nil}}} )
 end) )
 end) )
 end) )
 end)(var(_S35S461184, "#.1184") )
 end });
 ignore(_max)_min = setmetatable({args=symbol('#.1201'),doc="Return the minimum of the given arguments."}, { __call = function(_S35S461208 ,  ...)
 local _S35S461201 = list(...);
 return (function(_S35S461202  )
 return (function(_S35S461203  )
 if _caseS45pairS63(var(_S35S461202, "#.1202") ) then return (function(_x  )
 if _S61(scm_nil,  (_S35S461202)[2] ) then return (function()
 return var(_x, "x")
 end)() else return var(_S35S461203, "#.1203")() end
 end)((_S35S461202)[1] ) else return var(_S35S461203, "#.1203")() end
 end)((function()
 return (function(_S35S461204  )
 if _caseS45pairS63(var(_S35S461202, "#.1202") ) then return (function(_x  )
 return (function(_S35S461207  )
 if _caseS45pairS63((_S35S461202)[2] ) then return (function(_y  )
 if _S61(scm_nil,  ((_S35S461202)[2])[2] ) then return (function()
 if var(_S62, ">")(var(_x, "x"),  var(_y, "y") ) then return _y else return _x end
 end)() else return var(_S35S461207, "#.1207")() end
 end)(((_S35S461202)[2])[1] ) else return var(_S35S461207, "#.1207")() end
 end)((function()
 return var(_S35S461204, "#.1204")()
 end) )
 end)((_S35S461202)[1] ) else return var(_S35S461204, "#.1204")() end
 end)((function()
 ...
 end)(((_S35S461202)[2])[1] ) else return var(_S35S461206, "#.1206")() end
 end)((function()
 return var(_S35S461205, "#.1205")()
 end) )
 end)((_S35S461202)[1] ) else return var(_S35S461205, "#.1205")() end
 end)((function()
 return var(_error, "error")("no matching case for ",  var(_S35S461201, "#.1201"),  " in ",  {{{symbol('x'),scm_nil},{symbol('x'),scm_nil}},{{{symbol('x'),{symbol('y'),scm_nil}},{{symbol('if'),{{symbol('>'),{symbol('x'),{symbol('y'),scm_nil}}},{symbol('y'),{symbol('x'),scm_nil}}}},scm_nil}},{{{symbol('x'),{symbol('y'),symbol('z')}},{{symbol('if'),{{symbol('>'),{symbol('x'),{symbol('y'),scm_nil}}},{{symbol('apply'),{symbol('min'),{{symbol('cons'),{symbol('y'),{symbol('z'),scm_nil}}},scm_nil}}},{{symbol('apply'),{symbol('min'),{{symbol('cons'),{symbol('x'),{symbol('z'),scm_nil}}},scm_nil}}},scm_nil}}}},scm_nil}},scm_nil}}} )
 end) )
 end) )
 end) )
 end)(var(_S35S461201, "#.1201") )
 end });
 ...
 ignore(_tenth)_integerS63 = setmetatable({args={symbol('x'),scm_nil},doc="Return #t if ,x is an exact number that is not a rational."}, { __call = function(_S35S461218 ,  _x  )
 ...
 return setmetatable({args=symbol('#.1220'),doc="(map proc list ...) applies proc element-wise to the elements of\
       ...
       arguments."}, { __call = function(_S35S461230 ,  ...)
 local _S35S461220 = list(...);
 return (function(_S35S461221  )
 return (function(_S35S461222  )
 if _caseS45pairS63(var(_S35S461221, "#.1221") ) then return (function(_f  )
 return (function(_S35S461228  )
 if _caseS45pairS63((_S35S461221)[2] ) then return (function(_l  )
 if _S61(scm_nil,  ((_S35S461221)[2])[2] ) then return (function()
 (function(_S35S461234)
 if _S35S461234 then
 ...
 end)() else return var(_S35S461228, "#.1228")() end
 end)(((_S35S461221)[2])[1] ) else return var(_S35S461228, "#.1228")() end
 end)((function()
 return var(_S35S461222, "#.1222")()
 end) )
 end)((_S35S461221)[1] ) else return var(_S35S461222, "#.1222")() end
 end)((function()
 return (function(_S35S461223  )
 if _caseS45pairS63(var(_S35S461221, "#.1221") ) then return (function(_f  )
 return (function(_S35S461226  )
 if _caseS45pairS63((_S35S461221)[2] ) then return (function(_l1  )
 return (function(_S35S461227  )
 if _caseS45pairS63(((_S35S461221)[2])[2] ) then return (function(_l2  )
 if _S61(scm_nil,  (((_S35S461221)[2])[2])[2] ) then return (function()
 (function(_S35S461240)
 if _S35S461240 then
 return var(_error, "error")("In function ",  symbol('map'),  ": the argument ",  symbol('f'),  "was expected to be a ",  symbol('procedure?') ) else
 return false
 end
 ...
 end)((((_S35S461221)[2])[2])[1] ) else return var(_S35S461227, "#.1227")() end
 end)((function()
 return var(_S35S461226, "#.1226")()
 end) )
 end)(((_S35S461221)[2])[1] ) else return var(_S35S461226, "#.1226")() end
 end)((function()
 return var(_S35S461223, "#.1223")()
 end) )
 end)((_S35S461221)[1] ) else return var(_S35S461223, "#.1223")() end
 end)((function()
 ...
 end)(((_S35S461221)[2])[1] ) else return var(_S35S461225, "#.1225")() end
 end)((function()
 return var(_S35S461224, "#.1224")()
 end) )
 end)((_S35S461221)[1] ) else return var(_S35S461224, "#.1224")() end
 end)((function()
 return var(_error, "error")("no matching case for ",  var(_S35S461220, "#.1220"),  " in ",  {{{symbol('f'),{symbol('l'),scm_nil}},{{symbol('check-parameter'),{symbol('f'),{symbol('procedure?'),{symbol('map'),scm_nil}}}},{{symbol('let'),{symbol('go'),{{{symbol('l'),{symbol('l'),scm_nil}},scm_nil},{{symbol('if'),{{symbol('null?'),{symbol('l'),scm_nil}},{{symbol('quote'),{scm_nil,scm_nil}},{{symbol('cons'),{{symbol('f'),{{symbol('car'),{symbol('l'),scm_nil}},scm_nil}},{{symbol('map'),{symbol('f'),{{symbol('cdr'),{symbol('l'),scm_nil}},scm_nil}}},scm_nil}}},scm_nil}}}},scm_nil}}}},scm_nil}}},{{{symbol('f'),{symbol('l1'),{symbol('l2'),scm_nil}}},{{symbol('check-parameter'),{symbol('f'),{symbol('procedure?'),{symbol('map'),scm_nil}}}},{{symbol('let'),{symbol('go'),{{{symbol('l1'),{symbol('l1'),scm_nil}},{{symbol('l2'),{symbol('l2'),scm_nil}},scm_nil}},{{symbol('cond'),{{{symbol('null?'),{symbol('l1'),scm_nil}},{{symbol('quote'),{scm_nil,scm_nil}},scm_nil}},{{{symbol('null?'),{symbol('l2'),scm_nil}},{{symbol('quote'),{scm_nil,scm_nil}},scm_nil}},{{symbol('else'),{{symbol('cons'),{{symbol('f'),{{symbol('car'),{symbol('l1'),scm_nil}},{{symbol('car'),{symbol('l2'),scm_nil}},scm_nil}}},{{symbol('go'),{{symbol('cdr'),{symbol('l2'),scm_nil}},{{symbol('cdr'),{symbol('l2'),scm_nil}},scm_nil}}},scm_nil}}},scm_nil}},scm_nil}}}},scm_nil}}}},scm_nil}}},{{{symbol('f'),{symbol('l1'),symbol('ls')}},{{symbol('check-parameter'),{symbol('f'),{symbol('procedure?'),{symbol('map'),scm_nil}}}},{{symbol('define'),{symbol('len'),{{symbol('fold1'),{{symbol('lambda'),{{symbol('ls'),{symbol('len'),scm_nil}},{{symbol('min'),{{symbol('length'),{symbol('ls'),scm_nil}},{symbol('len'),scm_nil}}},scm_nil}}},{{symbol('length'),{symbol('l1'),scm_nil}},{symbol('ls'),scm_nil}}}},scm_nil}}},{{symbol('let'),{symbol('go'),{{{symbol('l1'),{symbol('l1'),scm_nil}},{{symbol('ls'),{symbol('ls'),scm_nil}},{{symbol('len'),{symbol('len'),scm_nil}},scm_nil}}},{{symbol('if'),{{symbol('='),{symbol('len'),{0,scm_nil}}},{{symbol('quote'),{scm_nil,scm_nil}},{{symbol('cons'),{{symbol('apply'),{symbol('f'),{{symbol('cons'),{{symbol('car'),{symbol('l1'),scm_nil}},{{symbol('map'),{symbol('car'),{symbol('ls'),scm_nil}}},scm_nil}}},scm_nil}}},{{symbol('go'),{{symbol('cdr'),{symbol('l1'),scm_nil}},{{symbol('map'),{symbol('cdr'),{symbol('ls'),scm_nil}}},{{symbol('-'),{symbol('len'),{1,scm_nil}}},scm_nil}}}},scm_nil}}},scm_nil}}}},scm_nil}}}},scm_nil}}}},scm_nil}}} )
 end) )
 end) )
 end) )
 end)(var(_S35S461220, "#.1220") )
 end })
 end)();
 ...
 return setmetatable({args=symbol('#.1248'),doc="(for-each proc list ...) applies proc element-wise to the\
       ...
       of the arguments."}, { __call = function(_S35S461258 ,  ...)
 local _S35S461248 = list(...);
 return (function(_S35S461249  )
 return (function(_S35S461250  )
 if _caseS45pairS63(var(_S35S461249, "#.1249") ) then return (function(_f  )
 return (function(_S35S461256  )
 if _caseS45pairS63((_S35S461249)[2] ) then return (function(_l  )
 if _S61(scm_nil,  ((_S35S461249)[2])[2] ) then return (function()
 (function(_S35S461262)
 if _S35S461262 then
 return var(_error, "error")("In function ",  symbol('map'),  ": the argument ",  symbol('f'),  "was expected to be a ",  symbol('procedure?') ) else
 return false
 end
 ...
 end)() else return var(_S35S461256, "#.1256")() end
 end)(((_S35S461249)[2])[1] ) else return var(_S35S461256, "#.1256")() end
 end)((function()
 return var(_S35S461250, "#.1250")()
 end) )
 end)((_S35S461249)[1] ) else return var(_S35S461250, "#.1250")() end
 end)((function()
 return (function(_S35S461251  )
 if _caseS45pairS63(var(_S35S461249, "#.1249") ) then return (function(_f  )
 return (function(_S35S461254  )
 if _caseS45pairS63((_S35S461249)[2] ) then return (function(_l1  )
 return (function(_S35S461255  )
 if _caseS45pairS63(((_S35S461249)[2])[2] ) then return (function(_l2  )
 if _S61(scm_nil,  (((_S35S461249)[2])[2])[2] ) then return (function()
 (function(_S35S461268)
 if _S35S461268 then
 return var(_error, "error")("In function ",  symbol('map'),  ": the argument ",  symbol('f'),  "was expected to be a ",  symbol('procedure?') ) else
 return false
 end
 ...
 end)((((_S35S461249)[2])[2])[1] ) else return var(_S35S461255, "#.1255")() end
 end)((function()
 return var(_S35S461254, "#.1254")()
 end) )
 end)(((_S35S461249)[2])[1] ) else return var(_S35S461254, "#.1254")() end
 end)((function()
 return var(_S35S461251, "#.1251")()
 end) )
 end)((_S35S461249)[1] ) else return var(_S35S461251, "#.1251")() end
 end)((function()
 ...
 end)(((_S35S461249)[2])[1] ) else return var(_S35S461253, "#.1253")() end
 end)((function()
 return var(_S35S461252, "#.1252")()
 end) )
 end)((_S35S461249)[1] ) else return var(_S35S461252, "#.1252")() end
 end)((function()
 return var(_error, "error")("no matching case for ",  var(_S35S461248, "#.1248"),  " in ",  {{{symbol('f'),{symbol('l'),scm_nil}},{{symbol('check-parameter'),{symbol('f'),{symbol('procedure?'),{symbol('map'),scm_nil}}}},{{symbol('let'),{symbol('go'),{{{symbol('l'),{symbol('l'),scm_nil}},scm_nil},{{symbol('if'),{{symbol('null?'),{symbol('l'),scm_nil}},{{symbol('quote'),{scm_nil,scm_nil}},{{symbol('begin'),{{symbol('f'),{{symbol('car'),{symbol('l'),scm_nil}},scm_nil}},{{symbol('map'),{symbol('f'),{{symbol('cdr'),{symbol('l'),scm_nil}},scm_nil}}},scm_nil}}},scm_nil}}}},scm_nil}}}},scm_nil}}},{{{symbol('f'),{symbol('l1'),{symbol('l2'),scm_nil}}},{{symbol('check-parameter'),{symbol('f'),{symbol('procedure?'),{symbol('map'),scm_nil}}}},{{symbol('let'),{symbol('go'),{{{symbol('l1'),{symbol('l1'),scm_nil}},{{symbol('l2'),{symbol('l2'),scm_nil}},scm_nil}},{{symbol('cond'),{{{symbol('null?'),{symbol('l1'),scm_nil}},{{symbol('quote'),{scm_nil,scm_nil}},scm_nil}},{{{symbol('null?'),{symbol('l2'),scm_nil}},{{symbol('quote'),{scm_nil,scm_nil}},scm_nil}},{{symbol('else'),{{symbol('f'),{{symbol('car'),{symbol('l1'),scm_nil}},{{symbol('car'),{symbol('l2'),scm_nil}},scm_nil}}},{{symbol('go'),{{symbol('cdr'),{symbol('l2'),scm_nil}},{{symbol('cdr'),{symbol('l2'),scm_nil}},scm_nil}}},scm_nil}}},scm_nil}}}},scm_nil}}}},scm_nil}}},{{{symbol('f'),{symbol('l1'),symbol('ls')}},{{symbol('check-parameter'),{symbol('f'),{symbol('procedure?'),{symbol('map'),scm_nil}}}},{{symbol('define'),{symbol('len'),{{symbol('fold1'),{{symbol('lambda'),{{symbol('ls'),{symbol('len'),scm_nil}},{{symbol('min'),{{symbol('length'),{symbol('ls'),scm_nil}},{symbol('len'),scm_nil}}},scm_nil}}},{{symbol('length'),{symbol('l1'),scm_nil}},{symbol('ls'),scm_nil}}}},scm_nil}}},{{symbol('let'),{symbol('go'),{{{symbol('l1'),{symbol('l1'),scm_nil}},{{symbol('ls'),{symbol('ls'),scm_nil}},{{symbol('len'),{symbol('len'),scm_nil}},scm_nil}}},{{symbol('if'),{{symbol('='),{symbol('len'),{0,scm_nil}}},{{symbol('quote'),{scm_nil,scm_nil}},{{symbol('begin'),{{symbol('apply'),{symbol('f'),{{symbol('cons'),{{symbol('car'),{symbol('l1'),scm_nil}},{{symbol('map'),{symbol('car'),{symbol('ls'),scm_nil}}},scm_nil}}},scm_nil}}},{{symbol('go'),{{symbol('cdr'),{symbol('l1'),scm_nil}},{{symbol('map'),{symbol('cdr'),{symbol('ls'),scm_nil}}},{{symbol('-'),{symbol('len'),{1,scm_nil}}},scm_nil}}}},scm_nil}}},scm_nil}}}},scm_nil}}}},scm_nil}}}},scm_nil}}} )
 end) )
 end) )
 end) )
 end)(var(_S35S461248, "#.1248") )
 end })
 end)();
 ignore(_forS45each)_reverse = setmetatable({args={symbol('l'),scm_nil},doc="Reverse the list ,l."}, { __call = function(_S35S461276 ,  _l  )
 local _go;
 ...
 ignore(_reverse)_numberS45S62string = setmetatable({args={symbol('x'),scm_nil},doc="Convert the number ,x to a string representation that can be read\
  back."}, { __call = function(_S35S461278 ,  _x  )
 return _callS47native(symbol('tostring'),  var(_x, "x") )
 end });
 ignore(_numberS45S62string)_stringS45S62number = setmetatable({args={symbol('x'),scm_nil},doc="Convert the string ,x to a number, returning #f on failure."}, { __call = function(_S35S461279 ,  _x  )
 ...
 ignore(_stringS45S62number)_exactS45S62inexact = setmetatable({args={symbol('x'),scm_nil},doc="Convert an exact number (integer or rational) to an inexact number\
  ...
  numbers."}, { __call = function(_S35S461281 ,  _x  )
 (function()
 (function(_S35S461282)
 if _S35S461282 then
...
" ) else
 ...
 ignore(_exactS45S62inexact)_symbolS45S62string = setmetatable({args={symbol('x'),scm_nil},doc="Return the string contents of the symbol ,x."}, { __call = function(_S35S461284 ,  _x  )
 return (var(_x, "x"))[1]
 end });
 ignore(_symbolS45S62string)_stringS45S62symbol = setmetatable({args={symbol('x'),scm_nil},doc="Return a symbol with string contents ,x. This symbol is guaranteed to\
  ...
  addition, they are guaranteed to be the same object in memory."}, { __call = function(_S35S461285 ,  _x  )
 return _callS47native(symbol('symbol'),  var(_x, "x") )
 end });
 ignore(_stringS45S62symbol)_hashS45tableS45size = setmetatable({args={symbol('table'),scm_nil},doc="Return the number of entries in the hash-table ,table."}, { __call = function(_S35S461286 ,  _table  )
 local _x;
 _x = 1;
 var(_hashS45forS45each, "hash-for-each")(var(_table, "table"),  (function(_k ,  _v  )
 return (function()
 ...
 ignore(_hashS45tableS45size)_remainder = setmetatable({args={symbol('x'),{symbol('y'),scm_nil}},doc="Return the remainder of the division of ,x by ,y."}, { __call = function(_S35S461287 ,  _x ,  _y  )
 ...
 ignore(_remainder)_floorS47 = setmetatable({args={symbol('x'),{symbol('y'),scm_nil}},doc="Number-theoretic division (integer) division of ,x by ,y. This\
  ...
  floor of the result of the division and ,nr is the remainder."}, { __call = function(_S35S461288 ,  _x ,  _y  )
 return (function(_nq  )
 ...
 ignore(_floorS47)_floorS45quotient = setmetatable({args={symbol('x'),{symbol('y'),scm_nil}},doc="Return the quotient of ,x by ,y in the sense of 'floor/."}, { __call = function(_S35S461289 ,  _x ,  _y  )
 ...
 ignore(_floorS45quotient)_floorS45remainder = setmetatable({args={symbol('x'),{symbol('y'),scm_nil}},doc="Return the remainder of ,x by ,y in the sense of 'floor/."}, { __call = function(_S35S461290 ,  _x ,  _y  )
 return var(_callS45withS45values, "call-with-values")((function()
 return _floorS47(var(_x, "x"),  var(_y, "y") )
 end),  (function(_nq ,  _nr  )
 return var(_nqr, "nqr")
 ...
 ignore(_floorS45remainder)_truncateS47 = setmetatable({args={symbol('x'),{symbol('y'),scm_nil}},doc="Number-theoretic division (integer) division of ,x by ,y. This\
  procedure returns two integers, ,nq and ,nr, such that ,nq is the\
  truncation of the result of the division and ,nr is the remainder."}, { __call = function(_S35S461291 ,  _x ,  _y  )
 return (function(_nq  )
 return var(_values, "values")(var(_nq, "nq"),  var(_S45, "-")(var(_x, "x"),  var(_S42, "*")(var(_y, "y"),  _nq ) ) )
 end)(var(_truncate, "truncate")(var(_S47, "/")(var(_x, "x"),  var(_y, "y") ) ) )
 end });
 ignore(_truncateS47)_truncateS45quotient = setmetatable({args={symbol('x'),{symbol('y'),scm_nil}},doc="Return the quotient of ,x by ,y in the sense of 'truncate/."}, { __call = function(_S35S461292 ,  _x ,  _y  )
 return var(_callS45withS45values, "call-with-values")((function()
 ...
 ignore(_truncateS45quotient)_truncateS45remainder = setmetatable({args={symbol('x'),{symbol('y'),scm_nil}},doc="Return the remainder of ,x by ,y in the sense of 'truncate/."}, { __call = function(_S35S461293 ,  _x ,  _y  )
 return var(_callS45withS45values, "call-with-values")((function()
 return _truncateS47(var(_x, "x"),  var(_y, "y") )
 end),  (function(_nq ,  _nr  )
 return var(_nqr, "nqr")
 ...
 ignore(_truncateS45remainder)_inexactS45S62exact = setmetatable({args={symbol('q'),scm_nil},doc="If ,q is an inexact number, return a rational approximation ,r of ,q\
  ...
  decimal digits reported by (round (/ (log (floating-part ,r)) (log 10)))."}, { __call = function(_S35S461294 ,  _q  )
 ...
 ignore(_inexactS45S62exact)_exact = setmetatable({args={symbol('q'),scm_nil},doc="R7RS name for 'inexact->exact."}, { __call = function(_S35S461297 ,  _q  )
 return _inexactS45S62exact(var(_q, "q") )
 end });
 ignore(_exact)_inexact = setmetatable({args={symbol('q'),scm_nil},doc="R7RS name for 'exact->inexact"}, { __call = function(_S35S461298 ,  _q  )
 return _exactS45S62inexact(var(_q, "q") )
 end });
 ignore(_inexact)_fractionalS45part = setmetatable({args={symbol('r'),scm_nil},doc="Return the fractional part of ,r."}, { __call = function(_S35S461299 ,  _r  )
 return var(_callS45withS45values, "call-with-values")((function()
 ...
 ignore(_fractionalS45part)_numerator = setmetatable({args={symbol('q'),scm_nil},doc="Return the numerator of ,q, with ,q expressed as a fraction in\
  ...
  return ,q. For details of the conversion, see 'inexact->exact."}, { __call = function(_S35S461300 ,  _q  )
 ...
 ignore(_numerator)_denominator = setmetatable({args={symbol('q'),scm_nil},doc="Return the denominator of ,q, with ,q expressed as a fraction in\
  simplest terms if it is an inexact number. If ,q is an exact integer,\
  return 1. For details of the conversion, see 'inexact->exact."}, { __call = function(_S35S461304 ,  _q  )
 if var(_rationalS63, "rational?")(var(_q, "q") ) then return (function()
 return (_q)[2]
 end)() else if var(_exactS63, "exact?")(_q ) then return (function()
 return 1
 ...
 ignore(_floor)_ceiling = setmetatable({args={symbol('x'),scm_nil},doc="Return ,x rounded up. If x is an exact rational, interpret it as an\
  inexact float first."}, { __call = function(_S35S461309 ,  _x  )
 ...
 ignore(_ceiling)_round = setmetatable({args={symbol('x'),scm_nil},doc="Return ,x rounded towards the nearest integer. If x is an exact\
  rational, interpret it as an inexact float first."}, { __call = function(_S35S461310 ,  _x  )
 (function()
 ...
 ignore(_round)_truncate = setmetatable({args={symbol('x'),scm_nil},doc="Returns the integer closest to ,x whose absolute value is not greater\
  than |,x|."}, { __call = function(_S35S461312 ,  _x  )
 return var(_callS45withS45values, "call-with-values")((function()
 ...
 ignore(_truncate)_nanS63 = setmetatable({args={symbol('x'),scm_nil},doc="Returns #t if x is the floating point value NaN."}, { __call = function(_S35S461313 ,  _x  )
 return _not(_S61(var(_x, "x"),  _x ) )
 end });
 ignore(_nanS63)ignore(_pushS45macroS33(symbol('define-iterated-comparison'),  (function(_S35S461314  )
 ...
 local _c;
 _c = _gensym();
 return {symbol('define'), {var(_operator, "operator"), {{symbol('begin'), {{symbol('define'), {{var(_op, "op"), {var(_a, "a"), {var(_b, "b"), scm_nil}}}, {(function(_S35S461316)
 if _S35S461316 then
 return false else
 ...
 end),  var(_S35S461314, "#.1314") )
 end) ))_stringS60S63 = (function()
 local _S35S461317;
 _S35S461317 = (function(_S35S461319 ,  _S35S461320  )
 (function()
 (function(_S35S461329)
 if _S35S461329 then
 return var(_error, "error")("In function ",  {symbol('quote'),{symbol('string<?'),scm_nil}},  ": the argument ",  symbol('#.1319'),  "was expected to be a ",  symbol('string?') ) else
 return false
 end
 end)(_not(var(_stringS63, "string?")(var(_S35S461319, "#.1319") ) ));
 if _not(_stringS63(var(_S35S461320, "#.1320") ) ) then return _error("In function ",  {symbol('quote'),{symbol('string<?'),scm_nil}},  ": the argument ",  symbol('#.1320'),  "was expected to be a ",  symbol('string?') ) else return false end
 end)();
 return _callS47native(symbol('load'),  "local x, y = ...; return x < y" )(var(_S35S461319, "#.1319"),  var(_S35S461320, "#.1320") )
 end);
 local _S35S461318;
 _S35S461318 = setmetatable({args=symbol('#.1322'),doc="Return #t if the sequence of strings given by the arguments is\
   monotonically increasing."}, { __call = function(_S35S461331 ,  ...)
 local _S35S461322 = list(...);
 return (function(_S35S461323  )
 if _S61(scm_nil,  var(_S35S461323, "#.1323") ) then return (function()
 return true
 end)() else return (function(_S35S461324  )
 if _caseS45pairS63(_S35S461323 ) then return (function(_S35S461319  )
 if _S61(scm_nil,  (_S35S461323)[2] ) then return (function()
 return true
 end)() else return var(_S35S461324, "#.1324")() end
 end)((_S35S461323)[1] ) else return var(_S35S461324, "#.1324")() end
 end)((function()
 return (function(_S35S461325  )
 if _caseS45pairS63(_S35S461323 ) then return (function(_S35S461319  )
 return (function(_S35S461328  )
 if _caseS45pairS63((_S35S461323)[2] ) then return (function(_S35S461320  )
 if _S61(scm_nil,  ((_S35S461323)[2])[2] ) then return (function()
 return var(_S35S461317, "#.1317")(var(_S35S461319, "#.1319"),  var(_S35S461320, "#.1320") )
 end)() else return var(_S35S461328, "#.1328")() end
 end)(((_S35S461323)[2])[1] ) else return var(_S35S461328, "#.1328")() end
 end)((function()
 return var(_S35S461325, "#.1325")()
 end) )
 end)((_S35S461323)[1] ) else return var(_S35S461325, "#.1325")() end
 end)((function()
 return (function(_S35S461326  )
 if _caseS45pairS63(_S35S461323 ) then return (function(_S35S461319  )
 return (function(_S35S461327  )
 if _caseS45pairS63((_S35S461323)[2] ) then return (function(_S35S461320  )
 return (function(_S35S461321  )
 return (function()
 if var(_S35S461317, "#.1317")(var(_S35S461319, "#.1319"),  var(_S35S461320, "#.1320") ) then return var(_apply, "apply")(var(_S35S461318, "#.1318"),  {_S35S461320, var(_S35S461321, "#.1321")} ) else return false end
 end)()
 end)(((_S35S461323)[2])[2] )
 end)(((_S35S461323)[2])[1] ) else return var(_S35S461327, "#.1327")() end
 end)((function()
 return var(_S35S461326, "#.1326")()
 end) )
 end)((_S35S461323)[1] ) else return var(_S35S461326, "#.1326")() end
 end)((function()
 return var(_error, "error")("no matching case for ",  var(_S35S461322, "#.1322"),  " in ",  {{scm_nil,{true,scm_nil}},{{{symbol('#.1319'),scm_nil},{true,scm_nil}},{{{symbol('#.1319'),{symbol('#.1320'),scm_nil}},{{symbol('#.1317'),{symbol('#.1319'),{symbol('#.1320'),scm_nil}}},scm_nil}},{{{symbol('#.1319'),{symbol('#.1320'),symbol('#.1321')}},{{symbol('and'),{{symbol('#.1317'),{symbol('#.1319'),{symbol('#.1320'),scm_nil}}},{{symbol('apply'),{symbol('#.1318'),{{symbol('cons'),{symbol('#.1320'),{symbol('#.1321'),scm_nil}}},scm_nil}}},scm_nil}}},scm_nil}},scm_nil}}}} )
 end) )
 end) )
 end) ) end
 end)(var(_S35S461322, "#.1322") )
 end });
 return var(_S35S461318, "#.1318")
 end)();
 ignore(_stringS60S63)_stringS60S61S63 = (function()
 local _S35S461341;
 _S35S461341 = (function(_S35S461343 ,  _S35S461344  )
 (function()
 (function(_S35S461353)
 if _S35S461353 then
 return var(_error, "error")("In function ",  {symbol('quote'),{symbol('string<=?'),scm_nil}},  ": the argument ",  symbol('#.1343'),  "was expected to be a ",  symbol('string?') ) else
 return false
 end
 end)(_not(var(_stringS63, "string?")(var(_S35S461343, "#.1343") ) ));
 if _not(_stringS63(var(_S35S461344, "#.1344") ) ) then return _error("In function ",  {symbol('quote'),{symbol('string<=?'),scm_nil}},  ": the argument ",  symbol('#.1344'),  "was expected to be a ",  symbol('string?') ) else return false end
 end)();
 return _callS47native(symbol('load'),  "local x, y = ...; return x <= y" )(var(_S35S461343, "#.1343"),  var(_S35S461344, "#.1344") )
 end);
 local _S35S461342;
 _S35S461342 = setmetatable({args=symbol('#.1346'),doc="Return #t if the sequence of strings given by the arguments is\
   monotonically nondecreasing."}, { __call = function(_S35S461355 ,  ...)
 local _S35S461346 = list(...);
 return (function(_S35S461347  )
 if _S61(scm_nil,  var(_S35S461347, "#.1347") ) then return (function()
 return true
 end)() else return (function(_S35S461348  )
 if _caseS45pairS63(_S35S461347 ) then return (function(_S35S461343  )
 if _S61(scm_nil,  (_S35S461347)[2] ) then return (function()
 return true
 end)() else return var(_S35S461348, "#.1348")() end
 end)((_S35S461347)[1] ) else return var(_S35S461348, "#.1348")() end
 end)((function()
 return (function(_S35S461349  )
 if _caseS45pairS63(_S35S461347 ) then return (function(_S35S461343  )
 return (function(_S35S461352  )
 if _caseS45pairS63((_S35S461347)[2] ) then return (function(_S35S461344  )
 if _S61(scm_nil,  ((_S35S461347)[2])[2] ) then return (function()
 return var(_S35S461341, "#.1341")(var(_S35S461343, "#.1343"),  var(_S35S461344, "#.1344") )
 end)() else return var(_S35S461352, "#.1352")() end
 end)(((_S35S461347)[2])[1] ) else return var(_S35S461352, "#.1352")() end
 end)((function()
 return var(_S35S461349, "#.1349")()
 end) )
 end)((_S35S461347)[1] ) else return var(_S35S461349, "#.1349")() end
 end)((function()
 return (function(_S35S461350  )
 if _caseS45pairS63(_S35S461347 ) then return (function(_S35S461343  )
 return (function(_S35S461351  )
 if _caseS45pairS63((_S35S461347)[2] ) then return (function(_S35S461344  )
 return (function(_S35S461345  )
 return (function()
 if var(_S35S461341, "#.1341")(var(_S35S461343, "#.1343"),  var(_S35S461344, "#.1344") ) then return var(_apply, "apply")(var(_S35S461342, "#.1342"),  {_S35S461344, var(_S35S461345, "#.1345")} ) else return false end
 end)()
 end)(((_S35S461347)[2])[2] )
 end)(((_S35S461347)[2])[1] ) else return var(_S35S461351, "#.1351")() end
 end)((function()
 return var(_S35S461350, "#.1350")()
 end) )
 end)((_S35S461347)[1] ) else return var(_S35S461350, "#.1350")() end
 end)((function()
 return var(_error, "error")("no matching case for ",  var(_S35S461346, "#.1346"),  " in ",  {{scm_nil,{true,scm_nil}},{{{symbol('#.1343'),scm_nil},{true,scm_nil}},{{{symbol('#.1343'),{symbol('#.1344'),scm_nil}},{{symbol('#.1341'),{symbol('#.1343'),{symbol('#.1344'),scm_nil}}},scm_nil}},{{{symbol('#.1343'),{symbol('#.1344'),symbol('#.1345')}},{{symbol('and'),{{symbol('#.1341'),{symbol('#.1343'),{symbol('#.1344'),scm_nil}}},{{symbol('apply'),{symbol('#.1342'),{{symbol('cons'),{symbol('#.1344'),{symbol('#.1345'),scm_nil}}},scm_nil}}},scm_nil}}},scm_nil}},scm_nil}}}} )
 end) )
 end) )
 end) ) end
 end)(var(_S35S461346, "#.1346") )
 end });
 return var(_S35S461342, "#.1342")
 end)();
 ignore(_stringS60S61S63)_stringS62S63 = (function()
 local _S35S461365;
 _S35S461365 = (function(_S35S461367 ,  _S35S461368  )
 (function()
 (function(_S35S461377)
 if _S35S461377 then
 return var(_error, "error")("In function ",  {symbol('quote'),{symbol('string>?'),scm_nil}},  ": the argument ",  symbol('#.1367'),  "was expected to be a ",  symbol('string?') ) else
 return false
 end
 end)(_not(var(_stringS63, "string?")(var(_S35S461367, "#.1367") ) ));
 if _not(_stringS63(var(_S35S461368, "#.1368") ) ) then return _error("In function ",  {symbol('quote'),{symbol('string>?'),scm_nil}},  ": the argument ",  symbol('#.1368'),  "was expected to be a ",  symbol('string?') ) else return false end
 end)();
 return _callS47native(symbol('load'),  "local x, y = ...; return x > y" )(var(_S35S461367, "#.1367"),  var(_S35S461368, "#.1368") )
 end);
 local _S35S461366;
 _S35S461366 = setmetatable({args=symbol('#.1370'),doc="Return #t if the sequence of strings given by the arguments is\
   monotonically decreasing."}, { __call = function(_S35S461379 ,  ...)
 local _S35S461370 = list(...);
 return (function(_S35S461371  )
 if _S61(scm_nil,  var(_S35S461371, "#.1371") ) then return (function()
 return true
 end)() else return (function(_S35S461372  )
 if _caseS45pairS63(_S35S461371 ) then return (function(_S35S461367  )
 if _S61(scm_nil,  (_S35S461371)[2] ) then return (function()
 return true
 end)() else return var(_S35S461372, "#.1372")() end
 end)((_S35S461371)[1] ) else return var(_S35S461372, "#.1372")() end
 end)((function()
 return (function(_S35S461373  )
 if _caseS45pairS63(_S35S461371 ) then return (function(_S35S461367  )
 return (function(_S35S461376  )
 if _caseS45pairS63((_S35S461371)[2] ) then return (function(_S35S461368  )
 if _S61(scm_nil,  ((_S35S461371)[2])[2] ) then return (function()
 return var(_S35S461365, "#.1365")(var(_S35S461367, "#.1367"),  var(_S35S461368, "#.1368") )
 end)() else return var(_S35S461376, "#.1376")() end
 end)(((_S35S461371)[2])[1] ) else return var(_S35S461376, "#.1376")() end
 end)((function()
 return var(_S35S461373, "#.1373")()
 end) )
 end)((_S35S461371)[1] ) else return var(_S35S461373, "#.1373")() end
 end)((function()
 return (function(_S35S461374  )
 if _caseS45pairS63(_S35S461371 ) then return (function(_S35S461367  )
 return (function(_S35S461375  )
 if _caseS45pairS63((_S35S461371)[2] ) then return (function(_S35S461368  )
 return (function(_S35S461369  )
 return (function()
 if var(_S35S461365, "#.1365")(var(_S35S461367, "#.1367"),  var(_S35S461368, "#.1368") ) then return var(_apply, "apply")(var(_S35S461366, "#.1366"),  {_S35S461368, var(_S35S461369, "#.1369")} ) else return false end
 end)()
 end)(((_S35S461371)[2])[2] )
 end)(((_S35S461371)[2])[1] ) else return var(_S35S461375, "#.1375")() end
 end)((function()
 return var(_S35S461374, "#.1374")()
 end) )
 end)((_S35S461371)[1] ) else return var(_S35S461374, "#.1374")() end
 end)((function()
 return var(_error, "error")("no matching case for ",  var(_S35S461370, "#.1370"),  " in ",  {{scm_nil,{true,scm_nil}},{{{symbol('#.1367'),scm_nil},{true,scm_nil}},{{{symbol('#.1367'),{symbol('#.1368'),scm_nil}},{{symbol('#.1365'),{symbol('#.1367'),{symbol('#.1368'),scm_nil}}},scm_nil}},{{{symbol('#.1367'),{symbol('#.1368'),symbol('#.1369')}},{{symbol('and'),{{symbol('#.1365'),{symbol('#.1367'),{symbol('#.1368'),scm_nil}}},{{symbol('apply'),{symbol('#.1366'),{{symbol('cons'),{symbol('#.1368'),{symbol('#.1369'),scm_nil}}},scm_nil}}},scm_nil}}},scm_nil}},scm_nil}}}} )
 end) )
 end) )
 end) ) end
 end)(var(_S35S461370, "#.1370") )
 end });
 return var(_S35S461366, "#.1366")
 end)();
 ignore(_stringS62S63)_stringS62S61S63 = (function()
 local _S35S461389;
 _S35S461389 = (function(_S35S461391 ,  _S35S461392  )
 (function()
 (function(_S35S461401)
 if _S35S461401 then
 return var(_error, "error")("In function ",  {symbol('quote'),{symbol('string>=?'),scm_nil}},  ": the argument ",  symbol('#.1391'),  "was expected to be a ",  symbol('string?') ) else
 return false
 end
 end)(_not(var(_stringS63, "string?")(var(_S35S461391, "#.1391") ) ));
 if _not(_stringS63(var(_S35S461392, "#.1392") ) ) then return _error("In function ",  {symbol('quote'),{symbol('string>=?'),scm_nil}},  ": the argument ",  symbol('#.1392'),  "was expected to be a ",  symbol('string?') ) else return false end
 end)();
 return _callS47native(symbol('load'),  "local x, y = ...; return x >= y" )(var(_S35S461391, "#.1391"),  var(_S35S461392, "#.1392") )
 end);
 local _S35S461390;
 _S35S461390 = setmetatable({args=symbol('#.1394'),doc="Return #t if the sequence of strings given by the arguments is\
   monotonically nonincreasing."}, { __call = function(_S35S461403 ,  ...)
 local _S35S461394 = list(...);
 return (function(_S35S461395  )
 if _S61(scm_nil,  var(_S35S461395, "#.1395") ) then return (function()
 return true
 end)() else return (function(_S35S461396  )
 if _caseS45pairS63(_S35S461395 ) then return (function(_S35S461391  )
 if _S61(scm_nil,  (_S35S461395)[2] ) then return (function()
 return true
 end)() else return var(_S35S461396, "#.1396")() end
 end)((_S35S461395)[1] ) else return var(_S35S461396, "#.1396")() end
 end)((function()
 return (function(_S35S461397  )
 if _caseS45pairS63(_S35S461395 ) then return (function(_S35S461391  )
 return (function(_S35S461400  )
 if _caseS45pairS63((_S35S461395)[2] ) then return (function(_S35S461392  )
 if _S61(scm_nil,  ((_S35S461395)[2])[2] ) then return (function()
 return var(_S35S461389, "#.1389")(var(_S35S461391, "#.1391"),  var(_S35S461392, "#.1392") )
 end)() else return var(_S35S461400, "#.1400")() end
 end)(((_S35S461395)[2])[1] ) else return var(_S35S461400, "#.1400")() end
 end)((function()
 return var(_S35S461397, "#.1397")()
 end) )
 end)((_S35S461395)[1] ) else return var(_S35S461397, "#.1397")() end
 end)((function()
 return (function(_S35S461398  )
 if _caseS45pairS63(_S35S461395 ) then return (function(_S35S461391  )
 return (function(_S35S461399  )
 if _caseS45pairS63((_S35S461395)[2] ) then return (function(_S35S461392  )
 return (function(_S35S461393  )
 return (function()
 if var(_S35S461389, "#.1389")(var(_S35S461391, "#.1391"),  var(_S35S461392, "#.1392") ) then return var(_apply, "apply")(var(_S35S461390, "#.1390"),  {_S35S461392, var(_S35S461393, "#.1393")} ) else return false end
 end)()
 end)(((_S35S461395)[2])[2] )
 end)(((_S35S461395)[2])[1] ) else return var(_S35S461399, "#.1399")() end
 end)((function()
 return var(_S35S461398, "#.1398")()
 end) )
 end)((_S35S461395)[1] ) else return var(_S35S461398, "#.1398")() end
 end)((function()
 return var(_error, "error")("no matching case for ",  var(_S35S461394, "#.1394"),  " in ",  {{scm_nil,{true,scm_nil}},{{{symbol('#.1391'),scm_nil},{true,scm_nil}},{{{symbol('#.1391'),{symbol('#.1392'),scm_nil}},{{symbol('#.1389'),{symbol('#.1391'),{symbol('#.1392'),scm_nil}}},scm_nil}},{{{symbol('#.1391'),{symbol('#.1392'),symbol('#.1393')}},{{symbol('and'),{{symbol('#.1389'),{symbol('#.1391'),{symbol('#.1392'),scm_nil}}},{{symbol('apply'),{symbol('#.1390'),{{symbol('cons'),{symbol('#.1392'),{symbol('#.1393'),scm_nil}}},scm_nil}}},scm_nil}}},scm_nil}},scm_nil}}}} )
 end) )
 end) )
 end) ) end
 end)(var(_S35S461394, "#.1394") )
 end });
 return var(_S35S461390, "#.1390")
 end)();
 ignore(_stringS62S61S63)_stringS61S63 = (function()
 local _S35S461413;
 _S35S461413 = (function(_S35S461415 ,  _S35S461416  )
 (function()
 (function(_S35S461425)
 if _S35S461425 then
 return var(_error, "error")("In function ",  {symbol('quote'),{symbol('string=?'),scm_nil}},  ": the argument ",  symbol('#.1415'),  "was expected to be a ",  symbol('string?') ) else
 return false
 end
 end)(_not(var(_stringS63, "string?")(var(_S35S461415, "#.1415") ) ));
 if _not(_stringS63(var(_S35S461416, "#.1416") ) ) then return _error("In function ",  {symbol('quote'),{symbol('string=?'),scm_nil}},  ": the argument ",  symbol('#.1416'),  "was expected to be a ",  symbol('string?') ) else return false end
 end)();
 return _callS47native(symbol('load'),  "local x, y = ...; return x == y" )(var(_S35S461415, "#.1415"),  var(_S35S461416, "#.1416") )
 end);
 local _S35S461414;
 _S35S461414 = setmetatable({args=symbol('#.1418'),doc="Return #t if all the strings given are equal."}, { __call = function(_S35S461427 ,  ...)
 local _S35S461418 = list(...);
 return (function(_S35S461419  )
 if _S61(scm_nil,  var(_S35S461419, "#.1419") ) then return (function()
 return true
 end)() else return (function(_S35S461420  )
 if _caseS45pairS63(_S35S461419 ) then return (function(_S35S461415  )
 if _S61(scm_nil,  (_S35S461419)[2] ) then return (function()
 return true
 end)() else return var(_S35S461420, "#.1420")() end
 end)((_S35S461419)[1] ) else return var(_S35S461420, "#.1420")() end
 end)((function()
 return (function(_S35S461421  )
 if _caseS45pairS63(_S35S461419 ) then return (function(_S35S461415  )
 return (function(_S35S461424  )
 if _caseS45pairS63((_S35S461419)[2] ) then return (function(_S35S461416  )
 if _S61(scm_nil,  ((_S35S461419)[2])[2] ) then return (function()
 return var(_S35S461413, "#.1413")(var(_S35S461415, "#.1415"),  var(_S35S461416, "#.1416") )
 end)() else return var(_S35S461424, "#.1424")() end
 end)(((_S35S461419)[2])[1] ) else return var(_S35S461424, "#.1424")() end
 end)((function()
 return var(_S35S461421, "#.1421")()
 end) )
 end)((_S35S461419)[1] ) else return var(_S35S461421, "#.1421")() end
 end)((function()
 return (function(_S35S461422  )
 if _caseS45pairS63(_S35S461419 ) then return (function(_S35S461415  )
 return (function(_S35S461423  )
 if _caseS45pairS63((_S35S461419)[2] ) then return (function(_S35S461416  )
 return (function(_S35S461417  )
 return (function()
 if var(_S35S461413, "#.1413")(var(_S35S461415, "#.1415"),  var(_S35S461416, "#.1416") ) then return var(_apply, "apply")(var(_S35S461414, "#.1414"),  {_S35S461416, var(_S35S461417, "#.1417")} ) else return false end
 end)()
 end)(((_S35S461419)[2])[2] )
 end)(((_S35S461419)[2])[1] ) else return var(_S35S461423, "#.1423")() end
 end)((function()
 return var(_S35S461422, "#.1422")()
 end) )
 end)((_S35S461419)[1] ) else return var(_S35S461422, "#.1422")() end
 end)((function()
 return var(_error, "error")("no matching case for ",  var(_S35S461418, "#.1418"),  " in ",  {{scm_nil,{true,scm_nil}},{{{symbol('#.1415'),scm_nil},{true,scm_nil}},{{{symbol('#.1415'),{symbol('#.1416'),scm_nil}},{{symbol('#.1413'),{symbol('#.1415'),{symbol('#.1416'),scm_nil}}},scm_nil}},{{{symbol('#.1415'),{symbol('#.1416'),symbol('#.1417')}},{{symbol('and'),{{symbol('#.1413'),{symbol('#.1415'),{symbol('#.1416'),scm_nil}}},{{symbol('apply'),{symbol('#.1414'),{{symbol('cons'),{symbol('#.1416'),{symbol('#.1417'),scm_nil}}},scm_nil}}},scm_nil}}},scm_nil}},scm_nil}}}} )
 end) )
 end) )
 end) ) end
 end)(var(_S35S461418, "#.1418") )
 end });
 return var(_S35S461414, "#.1414")
 end)();
 ignore(_stringS61S63)_stringS45append = (function()
 local _append2;
 _append2 = _callS47native(symbol('load'),  "local x, y = ...; return x .. y" );
 return setmetatable({args=symbol('#.1437'),doc="Concatenate any number of strings."}, { __call = function(_S35S461444 ,  ...)
 local _S35S461437 = list(...);
 return (function(_S35S461438  )
 if _S61(scm_nil,  var(_S35S461438, "#.1438") ) then return (function()
 return ""
 end)() else return (function(_S35S461439  )
 if _caseS45pairS63(_S35S461438 ) then return (function(_x  )
 if _S61(scm_nil,  (_S35S461438)[2] ) then return (function()
 return var(_x, "x")
 end)() else return var(_S35S461439, "#.1439")() end
 end)((_S35S461438)[1] ) else return var(_S35S461439, "#.1439")() end
 end)((function()
 return (function(_S35S461440  )
 if _caseS45pairS63(_S35S461438 ) then return (function(_x  )
 return (function(_S35S461443  )
 if _caseS45pairS63((_S35S461438)[2] ) then return (function(_y  )
 if _S61(scm_nil,  ((_S35S461438)[2])[2] ) then return (function()
 return var(_append2, "append2")(var(_x, "x"),  var(_y, "y") )
 end)() else return var(_S35S461443, "#.1443")() end
 end)(((_S35S461438)[2])[1] ) else return var(_S35S461443, "#.1443")() end
 end)((function()
 return var(_S35S461440, "#.1440")()
 end) )
 end)((_S35S461438)[1] ) else return var(_S35S461440, "#.1440")() end
 end)((function()
 ...
 end)(((_S35S461438)[2])[1] ) else return var(_S35S461442, "#.1442")() end
 end)((function()
 return var(_S35S461441, "#.1441")()
 end) )
 end)((_S35S461438)[1] ) else return var(_S35S461441, "#.1441")() end
 end)((function()
 return var(_error, "error")("no matching case for ",  var(_S35S461437, "#.1437"),  " in ",  {{scm_nil,{"",scm_nil}},{{{symbol('x'),scm_nil},{symbol('x'),scm_nil}},{{{symbol('x'),{symbol('y'),scm_nil}},{{symbol('append2'),{symbol('x'),{symbol('y'),scm_nil}}},scm_nil}},{{{symbol('x'),{symbol('y'),symbol('z')}},{{symbol('apply'),{symbol('string-append'),{{symbol('cons'),{{symbol('append2'),{symbol('x'),{symbol('y'),scm_nil}}},{symbol('z'),scm_nil}}},scm_nil}}},scm_nil}},scm_nil}}}} )
 end) )
 end) )
 end) ) end
 end)(var(_S35S461437, "#.1437") )
 end })
 end)();
 ignore(_stringS45append)_stringS45length = (function(_s  )
 (function(_S35S461453)
 if _S35S461453 then
 ...
 ignore(_stringS45length)_stringS45ref = setmetatable({args={symbol('s'),{symbol('i'),scm_nil}},doc="Return the ,i-th byte in the string ,s."}, { __call = function(_S35S461454 ,  _s ,  _i  )
 ...
 ignore(_stringS45ref)_exp = setmetatable({args={symbol('c'),scm_nil},doc="Return e^c."}, { __call = function(_S35S461457 ,  _c  )
 return _callS47native({symbol('math'),{symbol('exp'),scm_nil}},  _exactS45S62inexact(var(_c, "c") ) )
 end });
 ignore(_exp)_log = setmetatable({args={symbol('c'),scm_nil},doc="Return ln(c)."}, { __call = function(_S35S461458 ,  _c  )
 return _callS47native({symbol('math'),{symbol('log'),scm_nil}},  _exactS45S62inexact(var(_c, "c") ) )
 end });
 ignore(_log)_sin = setmetatable({args={symbol('c'),scm_nil},doc="Return sin(c)."}, { __call = function(_S35S461459 ,  _c  )
 return _callS47native({symbol('math'),{symbol('sin'),scm_nil}},  _exactS45S62inexact(var(_c, "c") ) )
 end });
 ignore(_sin)_cos = setmetatable({args={symbol('c'),scm_nil},doc="Return cos(c)."}, { __call = function(_S35S461460 ,  _c  )
 return _callS47native({symbol('math'),{symbol('cos'),scm_nil}},  _exactS45S62inexact(var(_c, "c") ) )
 end });
 ignore(_cos)_tan = setmetatable({args={symbol('c'),scm_nil},doc="Return tan(c)."}, { __call = function(_S35S461461 ,  _c  )
 return _callS47native({symbol('math'),{symbol('tan'),scm_nil}},  _exactS45S62inexact(var(_c, "c") ) )
 end });
 ignore(_tan)_expt = setmetatable({args={symbol('z1'),{symbol('z2'),scm_nil}},doc="Return z1^z2. More specifically, return e^z2 ln(z1)."}, { __call = function(_S35S461462 ,  _z1 ,  _z2  )
 return _exp(var(_S42, "*")(var(_z2, "z2"),  _log(var(_z1, "z1") ) ) )
 end });
 ignore(_expt)_abs = setmetatable({args={symbol('x'),scm_nil},doc="Return the absolute value of ,x."}, { __call = function(_S35S461463 ,  _x  )
 ...
 return setmetatable({args=symbol('#.1465'),doc="Return the greatest common divisor of the given numbers."}, { __call = function(_S35S461473 ,  ...)
 local _S35S461465 = list(...);
 return (function(_S35S461466  )
 if _S61(scm_nil,  var(_S35S461466, "#.1466") ) then return (function()
 return 0
 end)() else return (function(_S35S461467  )
 if _caseS45pairS63(_S35S461466 ) then return (function(_x  )
 if _S61(scm_nil,  (_S35S461466)[2] ) then return (function()
 return var(_x, "x")
 end)() else return var(_S35S461467, "#.1467")() end
 end)((_S35S461466)[1] ) else return var(_S35S461467, "#.1467")() end
 end)((function()
 return (function(_S35S461468  )
 if _caseS45pairS63(_S35S461466 ) then return (function(_x  )
 return (function(_S35S461471  )
 if _caseS45pairS63((_S35S461466)[2] ) then return (function(_y  )
 if _S61(scm_nil,  ((_S35S461466)[2])[2] ) then return (function()
 return var(_gcd2, "gcd2")(var(_x, "x"),  var(_y, "y") )
 end)() else return var(_S35S461471, "#.1471")() end
 end)(((_S35S461466)[2])[1] ) else return var(_S35S461471, "#.1471")() end
 end)((function()
 return var(_S35S461468, "#.1468")()
 end) )
 end)((_S35S461466)[1] ) else return var(_S35S461468, "#.1468")() end
 end)((function()
 ...
 end)(((_S35S461466)[2])[1] ) else return var(_S35S461470, "#.1470")() end
 end)((function()
 return var(_S35S461469, "#.1469")()
 end) )
 end)((_S35S461466)[1] ) else return var(_S35S461469, "#.1469")() end
 end)((function()
 return var(_error, "error")("no matching case for ",  var(_S35S461465, "#.1465"),  " in ",  {{scm_nil,{0,scm_nil}},{{{symbol('x'),scm_nil},{symbol('x'),scm_nil}},{{{symbol('x'),{symbol('y'),scm_nil}},{{symbol('gcd2'),{symbol('x'),{symbol('y'),scm_nil}}},scm_nil}},{{{symbol('x'),{symbol('y'),symbol('z')}},{{symbol('gcd2'),{symbol('x'),{{symbol('apply'),{symbol('gcd'),{{symbol('cons'),{symbol('y'),{symbol('z'),scm_nil}}},scm_nil}}},scm_nil}}},scm_nil}},scm_nil}}}} )
 end) )
 end) )
 end) ) end
 end)(var(_S35S461465, "#.1465") )
 end })
 end)();
 ignore(_gcd)_lcm = (function()
 local _lcm2;
 _lcm2 = (function(_a ,  _b  )
 if (function(_S35S461490)
 if _S35S461490 then
 ...
 return setmetatable({args=symbol('#.1482'),doc="Return the least common multiple of the given numbers."}, { __call = function(_S35S461491 ,  ...)
 local _S35S461482 = list(...);
 return (function(_S35S461483  )
 if _S61(scm_nil,  var(_S35S461483, "#.1483") ) then return (function()
 return 0
 end)() else return (function(_S35S461484  )
 if _caseS45pairS63(_S35S461483 ) then return (function(_x  )
 if _S61(scm_nil,  (_S35S461483)[2] ) then return (function()
 return var(_x, "x")
 end)() else return var(_S35S461484, "#.1484")() end
 end)((_S35S461483)[1] ) else return var(_S35S461484, "#.1484")() end
 end)((function()
 return (function(_S35S461485  )
 if _caseS45pairS63(_S35S461483 ) then return (function(_x  )
 return (function(_S35S461488  )
 if _caseS45pairS63((_S35S461483)[2] ) then return (function(_y  )
 if _S61(scm_nil,  ((_S35S461483)[2])[2] ) then return (function()
 return var(_lcm2, "lcm2")(var(_x, "x"),  var(_y, "y") )
 end)() else return var(_S35S461488, "#.1488")() end
 end)(((_S35S461483)[2])[1] ) else return var(_S35S461488, "#.1488")() end
 end)((function()
 return var(_S35S461485, "#.1485")()
 end) )
 end)((_S35S461483)[1] ) else return var(_S35S461485, "#.1485")() end
 end)((function()
 ...
 end)(((_S35S461483)[2])[1] ) else return var(_S35S461487, "#.1487")() end
 end)((function()
 return var(_S35S461486, "#.1486")()
 end) )
 end)((_S35S461483)[1] ) else return var(_S35S461486, "#.1486")() end
 end)((function()
 return var(_error, "error")("no matching case for ",  var(_S35S461482, "#.1482"),  " in ",  {{scm_nil,{0,scm_nil}},{{{symbol('x'),scm_nil},{symbol('x'),scm_nil}},{{{symbol('x'),{symbol('y'),scm_nil}},{{symbol('lcm2'),{symbol('x'),{symbol('y'),scm_nil}}},scm_nil}},{{{symbol('x'),{symbol('y'),symbol('z')}},{{symbol('lcm2'),{symbol('x'),{{symbol('apply'),{symbol('lcm'),{{symbol('cons'),{symbol('y'),{symbol('z'),scm_nil}}},scm_nil}}},scm_nil}}},scm_nil}},scm_nil}}}} )
 end) )
 end) )
 end) ) end
 end)(var(_S35S461482, "#.1482") )
 end })
 end)();
 ignore(_lcm)_newline = setmetatable({args=scm_nil,doc="Produces an end-of-line character on the standard output port."}, { __call = function(_S35S461500  )
 return var(_display, "display")("\
" )
 end });
 ...
 return setmetatable({args={symbol('x'),{symbol('y'),scm_nil}},doc="Return #t if ,x and ,y are equivalent in the sense of the R7RS\
      predicate of the same name."}, { __call = function(_S35S461501 ,  _x ,  _y  )
 ...
 ignore(_equalS63)_square = setmetatable({args={symbol('x'),scm_nil},doc="Returns the square of ,x. This is equivalent to ('* ,x ,x)."}, { __call = function(_S35S461506 ,  _x  )
 ...
 ignore(_sqrt)_makeS45list = setmetatable({args={symbol('k'),symbol('init')},doc="Return a newly-allocated list of size ,k. If the initial value\
   ,init is not given, it is taken to be #f."}, { __call = function(_S35S461510 ,  _k ,  ...)
 local _init = list(...);
 local _init;
 _init = (function(_S35S461511)
 if _S35S461511 then
 return false else
 ...
 ignore(_makeS45list)_booleanS63 = setmetatable({args={symbol('b'),scm_nil},doc="Return #t if ,b is a boolean."}, { __call = function(_S35S461516 ,  _b  )
 return (function(_S35S461513  )
 if var(_S35S461513, "#.1513") then return _S35S461513 else return (function(_S35S461514  )
 if var(_S35S461514, "#.1514") then return _S35S461514 else return false end
 ...
 ignore(_leaveS45scope)ignore(_pushS45macroS33(symbol('in-scope'),  (function(_S35S461522  )
...
", scm_nil} )} )
 ...
 ignore(_warn)ignore(_pushS45macroS33(symbol('warn-redefinition'),  (function(_S35S461523  )
 ...
 end)() else if (function(_S35S461535)
 if _S35S461535 then
 ...
 if var(_nullS63, "null?")(var(_args, "args") ) then return var(_empty, "empty") else if var(_symbolS63, "symbol?")((_args)[1] ) then return _compilerS45format("%s %s %s",  _escapeS45symbol((_args)[1] ),  (function(_S35S461545)
 if _S35S461545 then
 return "" else
 return ", "
 end
 end)((function(_S35S461546)
 if _S35S461546 then
 ...
 return (function(_S35S461549  )
 _leaveS45scope();
 return var(_S35S461549, "#.1549")
 end)((function()
 ...
 if var(_S35S461555, "#.1555") then return _S35S461555 else return (function(_S35S461556  )
 if var(_S35S461556, "#.1556") then return _S35S461556 else return false end
 end)((function(_S35S461566)
 if _S35S461566 then
 return (function(_S35S461558  )
 if var(_S35S461558, "#.1558") then return _S35S461558 else return (function(_S35S461559  )
 if var(_S35S461559, "#.1559") then return _S35S461559 else return false end
 ...
 return var(_return, "return")("false" )
 end)() else if (function(_S35S461573)
 if _S35S461573 then
 ...
 return var(_x, "x")
 end),  (_alist)[1] ),  (function(_S35S461580)
 if _S35S461580 then
 return "" else
 return ", "
 end
 ...
 ignore(_compileS45args)ignore(_pushS45macroS33(symbol('warn-extra-arguments'),  (function(_S35S461581  )
 ...
 end),  var(_S35S461581, "#.1581") )
 end) ))_compilationS45rules = _makeS45hashS45table();
 ignore(_compilationS45rules)_builtinS45functionS63 = (function(_s  )
 return (function(_S35S461582  )
 if var(_S35S461582, "#.1582") then return _S35S461582 else return (function(_S35S461583  )
 if var(_S35S461583, "#.1583") then return _S35S461583 else return (function(_S35S461584  )
 if var(_S35S461584, "#.1584") then return _S35S461584 else return false end
 end)(_S61(var(_s, "s"),  symbol('cdr') ) ) end
 end)(_S61(var(_s, "s"),  symbol('car') ) ) end
 end)(_S61(var(_s, "s"),  symbol('cons') ) )
 end);
 ignore(_builtinS45functionS63)ignore(_pushS45macroS33(symbol('define-compilation-rule'),  (function(_S35S461589  )
 return var(_apply, "apply")((function(_name ,  ...)
 local _body = list(...);
 ...
 return _compileS45simpleS45expression(var(_return, "return"),  _e )
 end)() else return var(_S35S461595, "#.1595")() end
 end)(var(_S35S461594, "#.1594") )
 end)((function()
 return (function(_S35S461596  )
 if _caseS45pairS63(var(_S35S461594, "#.1594") ) then if _S61(symbol('quote'),  (_S35S461594)[1] ) then return (function(_S35S461626  )
 if _caseS45pairS63((_S35S461594)[2] ) then return (function(_e  )
 if _S61(scm_nil,  ((_S35S461594)[2])[2] ) then return (function()
 return _compileS45quote(var(_return, "return"),  var(_e, "e") )
 end)() else return var(_S35S461626, "#.1626")() end
 end)(((_S35S461594)[2])[1] ) else return var(_S35S461626, "#.1626")() end
 end)((function()
 return var(_S35S461596, "#.1596")()
 end) ) else return var(_S35S461596, "#.1596")() end else return _S35S461596() end
 end)((function()
 return (function(_S35S461597  )
 return (function(_S35S461622  )
 if _caseS45pairS63(var(_S35S461594, "#.1594") ) then if _S61(symbol('lambda'),  (_S35S461594)[1] ) then return (function(_S35S461623  )
 if _caseS45pairS63((_S35S461594)[2] ) then return (function(_args  )
 return (function(_S35S461624  )
 if _caseS45pairS63(((_S35S461594)[2])[2] ) then return (function(_doc  )
 return (function(_S35S461625  )
 if _caseS45pairS63((((_S35S461594)[2])[2])[2] ) then return (function(_body1  )
 return (function(_body  )
 ...
 end)() else return var(_S35S461597, "#.1597")() end
 end)(((((_S35S461594)[2])[2])[2])[2] )
 end)(((((_S35S461594)[2])[2])[2])[1] ) else return var(_S35S461625, "#.1625")() end
 end)((function()
 return var(_S35S461624, "#.1624")()
 end) )
 end)((((_S35S461594)[2])[2])[1] ) else return var(_S35S461624, "#.1624")() end
 end)((function()
 return var(_S35S461623, "#.1623")()
 end) )
 end)(((_S35S461594)[2])[1] ) else return var(_S35S461623, "#.1623")() end
 end)((function()
 return var(_S35S461622, "#.1622")()
 end) ) else return var(_S35S461622, "#.1622")() end else return _S35S461622() end
 end)((function()
 return var(_S35S461597, "#.1597")()
 end) )
 end)((function()
 return (function(_S35S461598  )
 if _caseS45pairS63(var(_S35S461594, "#.1594") ) then if _S61(symbol('lambda'),  (_S35S461594)[1] ) then return (function(_S35S461621  )
 if _caseS45pairS63((_S35S461594)[2] ) then return (function(_args  )
 return (function(_body  )
 return (function()
 return (function(_ret  )
 ...
 end)(((_S35S461594)[2])[1] ) else return var(_S35S461621, "#.1621")() end
 end)((function()
 return var(_S35S461598, "#.1598")()
 end) ) else return var(_S35S461598, "#.1598")() end else return _S35S461598() end
 end)((function()
 return (function(_S35S461599  )
 return (function(_S35S461618  )
 if _caseS45pairS63(var(_S35S461594, "#.1594") ) then if _S61(symbol('define'),  (_S35S461594)[1] ) then return (function(_S35S461619  )
 if _caseS45pairS63((_S35S461594)[2] ) then return (function(_name  )
 return (function(_S35S461620  )
 if _caseS45pairS63(((_S35S461594)[2])[2] ) then return (function(_value  )
 if _S61(scm_nil,  (((_S35S461594)[2])[2])[2] ) then if var(_symbolS63, "symbol?")(var(_name, "name") ) then return (function()
 ...
 end)() else return var(_S35S461599, "#.1599")() end else return var(_S35S461620, "#.1620")() end
 end)((((_S35S461594)[2])[2])[1] ) else return var(_S35S461620, "#.1620")() end
 end)((function()
 return var(_S35S461619, "#.1619")()
 end) )
 end)(((_S35S461594)[2])[1] ) else return var(_S35S461619, "#.1619")() end
 end)((function()
 return var(_S35S461618, "#.1618")()
 end) ) else return var(_S35S461618, "#.1618")() end else return _S35S461618() end
 end)((function()
 return var(_S35S461599, "#.1599")()
 end) )
 end)((function()
 return (function(_S35S461600  )
 if _caseS45pairS63(var(_S35S461594, "#.1594") ) then if _S61(symbol('define'),  (_S35S461594)[1] ) then return (function(_S35S461616  )
 if _caseS45pairS63((_S35S461594)[2] ) then return (function(_S35S461617  )
 if _caseS45pairS63(((_S35S461594)[2])[1] ) then return (function(_name  )
 ...
 end)((((_S35S461594)[2])[1])[2] )
 end)((((_S35S461594)[2])[1])[1] ) else return var(_S35S461617, "#.1617")() end
 end)((function()
 return var(_S35S461616, "#.1616")()
 end) ) else return var(_S35S461616, "#.1616")() end
 end)((function()
 ...
 if _caseS45pairS63(var(_S35S461594, "#.1594") ) then if _S61(symbol('set!'),  (_S35S461594)[1] ) then return (function(_S35S461614  )
 if _caseS45pairS63((_S35S461594)[2] ) then return (function(_name  )
 return (function(_S35S461615  )
 if _caseS45pairS63(((_S35S461594)[2])[2] ) then return (function(_expr  )
 if _S61(scm_nil,  (((_S35S461594)[2])[2])[2] ) then return (function()
 return (function(_ret  )
 ...
 end)((((_S35S461594)[2])[2])[1] ) else return var(_S35S461615, "#.1615")() end
 end)((function()
 return var(_S35S461614, "#.1614")()
 end) )
 end)(((_S35S461594)[2])[1] ) else return var(_S35S461614, "#.1614")() end
 end)((function()
 ...
 if _caseS45pairS63(var(_S35S461594, "#.1594") ) then if _S61(symbol('if'),  (_S35S461594)[1] ) then return (function(_S35S461613  )
 if _caseS45pairS63((_S35S461594)[2] ) then return (function(_c  )
 if _S61(scm_nil,  ((_S35S461594)[2])[2] ) then return (function()
 return var(_error, "error")("If expression missing 'then' case: ",  {symbol('if'), {var(_c, "c"), scm_nil}} )
 end)() else return var(_S35S461613, "#.1613")() end
 end)(((_S35S461594)[2])[1] ) else return var(_S35S461613, "#.1613")() end
 end)((function()
 ...
 if _caseS45pairS63(var(_S35S461594, "#.1594") ) then if _S61(symbol('if'),  (_S35S461594)[1] ) then return (function(_S35S461611  )
 if _caseS45pairS63((_S35S461594)[2] ) then return (function(_c  )
 return (function(_S35S461612  )
 if _caseS45pairS63(((_S35S461594)[2])[2] ) then return (function(_t  )
 if _S61(scm_nil,  (((_S35S461594)[2])[2])[2] ) then return (function()
 local _it;
 ...
 end)((((_S35S461594)[2])[2])[1] ) else return var(_S35S461612, "#.1612")() end
 end)((function()
 return var(_S35S461611, "#.1611")()
 end) )
 end)(((_S35S461594)[2])[1] ) else return var(_S35S461611, "#.1611")() end
 end)((function()
 ...
 if _caseS45pairS63(var(_S35S461594, "#.1594") ) then if _S61(symbol('if'),  (_S35S461594)[1] ) then return (function(_S35S461608  )
 if _caseS45pairS63((_S35S461594)[2] ) then return (function(_c  )
 return (function(_S35S461609  )
 if _caseS45pairS63(((_S35S461594)[2])[2] ) then return (function(_t  )
 return (function(_S35S461610  )
 if _caseS45pairS63((((_S35S461594)[2])[2])[2] ) then return (function(_e  )
 if _S61(scm_nil,  ((((_S35S461594)[2])[2])[2])[2] ) then return (function()
 local _it;
 _it = _escapeS45symbol(var(_gensym, "gensym")() );
 ...
 end)() else return var(_S35S461610, "#.1610")() end
 end)(((((_S35S461594)[2])[2])[2])[1] ) else return var(_S35S461610, "#.1610")() end
 end)((function()
 return var(_S35S461609, "#.1609")()
 end) )
 end)((((_S35S461594)[2])[2])[1] ) else return var(_S35S461609, "#.1609")() end
 end)((function()
 return var(_S35S461608, "#.1608")()
 end) )
 end)(((_S35S461594)[2])[1] ) else return var(_S35S461608, "#.1608")() end
 end)((function()
 return var(_S35S461604, "#.1604")()
 end) ) else return var(_S35S461604, "#.1604")() end else return _S35S461604() end
 end)((function()
 return (function(_S35S461605  )
 return (function(_S35S461607  )
 if _caseS45pairS63(var(_S35S461594, "#.1594") ) then return (function(_fun  )
 return (function(_args  )
 ...
 end)() else return var(_S35S461605, "#.1605")() end
 end)((_S35S461594)[2] )
 end)((_S35S461594)[1] ) else return var(_S35S461607, "#.1607")() end
 end)((function()
 return var(_S35S461605, "#.1605")()
 end) )
 end)((function()
 ...
 end)((_S35S461594)[1] ) else return var(_S35S461606, "#.1606")() end
 end)((function()
 return false
 end) )
 end) )
 ...
 local _name;
 _name = (function(_S35S461677)
 if _S35S461677 then
 return (function(_S35S461678)
 if _S35S461678 then
 ...
 return (function(_S35S461676  )
 _leaveS45scope();
 return var(_S35S461676, "#.1676")
 end)((function()
 ...
 local _S35S461679 = list(...);
 return (function(_S35S461680  )
 if _S61(scm_nil,  var(_S35S461680, "#.1680") ) then return (function()
 return _repl(true,  1,  var(_ENV, "ENV"),  false )
 end)() else return (function(_S35S461681  )
 if _caseS45pairS63(_S35S461680 ) then return (function(_p  )
 if _S61(scm_nil,  (_S35S461680)[2] ) then return (function()
 return _repl(var(_p, "p"),  1,  var(_ENV, "ENV"),  false )
 end)() else return var(_S35S461681, "#.1681")() end
 end)((_S35S461680)[1] ) else return var(_S35S461681, "#.1681")() end
 end)((function()
 return (function(_S35S461682  )
 if _caseS45pairS63(_S35S461680 ) then return (function(_p  )
 return (function(_S35S461694  )
 if _caseS45pairS63((_S35S461680)[2] ) then return (function(_i  )
 if _S61(scm_nil,  ((_S35S461680)[2])[2] ) then return (function()
 return _repl(var(_p, "p"),  var(_i, "i"),  var(_ENV, "ENV"),  false )
 end)() else return var(_S35S461694, "#.1694")() end
 end)(((_S35S461680)[2])[1] ) else return var(_S35S461694, "#.1694")() end
 end)((function()
 return var(_S35S461682, "#.1682")()
 end) )
 end)((_S35S461680)[1] ) else return var(_S35S461682, "#.1682")() end
 end)((function()
 ...
 if _caseS45pairS63(((_S35S461680)[2])[2] ) then return (function(_env  )
 if _S61(scm_nil,  (((_S35S461680)[2])[2])[2] ) then return (function()
 return _repl(var(_p, "p"),  var(_i, "i"),  var(_env, "env"),  false )
 end)() else return var(_S35S461693, "#.1693")() end
 end)((((_S35S461680)[2])[2])[1] ) else return var(_S35S461693, "#.1693")() end
 end)((function()
 return var(_S35S461692, "#.1692")()
 end) )
 end)(((_S35S461680)[2])[1] ) else return var(_S35S461692, "#.1692")() end
 end)((function()
 return var(_S35S461683, "#.1683")()
 end) )
 end)((_S35S461680)[1] ) else return var(_S35S461683, "#.1683")() end
 end)((function()
 ...
 if _caseS45pairS63((((_S35S461680)[2])[2])[2] ) then if _S61(false,  ((((_S35S461680)[2])[2])[2])[1] ) then if _S61(scm_nil,  ((((_S35S461680)[2])[2])[2])[2] ) then return (function()
 return _repl(var(_p, "p"),  var(_i, "i"),  var(_env, "env"),  _phase(symbol('loading') ) )
 end)() else return var(_S35S461691, "#.1691")() end else return _S35S461691() end else return _S35S461691() end
 end)((function()
 return var(_S35S461690, "#.1690")()
 end) )
 end)((((_S35S461680)[2])[2])[1] ) else return var(_S35S461690, "#.1690")() end
 end)((function()
 return var(_S35S461689, "#.1689")()
 end) )
 end)(((_S35S461680)[2])[1] ) else return var(_S35S461689, "#.1689")() end
 end)((function()
 return var(_S35S461684, "#.1684")()
 end) )
 end)((_S35S461680)[1] ) else return var(_S35S461684, "#.1684")() end
 end)((function()
 ...
 if _caseS45pairS63((((_S35S461680)[2])[2])[2] ) then return (function(_old  )
 if _S61(scm_nil,  ((((_S35S461680)[2])[2])[2])[2] ) then return (function()
 (function(_S35S461716)
 if _S35S461716 then
...
" )
 ...
 end)() else return var(_S35S461688, "#.1688")() end
 end)(((((_S35S461680)[2])[2])[2])[1] ) else return var(_S35S461688, "#.1688")() end
 end)((function()
 return var(_S35S461687, "#.1687")()
 end) )
 end)((((_S35S461680)[2])[2])[1] ) else return var(_S35S461687, "#.1687")() end
 end)((function()
 return var(_S35S461686, "#.1686")()
 end) )
 end)(((_S35S461680)[2])[1] ) else return var(_S35S461686, "#.1686")() end
 end)((function()
 return var(_S35S461685, "#.1685")()
 end) )
 end)((_S35S461680)[1] ) else return var(_S35S461685, "#.1685")() end
 end)((function()
 return var(_error, "error")("no matching case for ",  var(_S35S461679, "#.1679"),  " in ",  {{scm_nil,{{symbol('repl'),{true,{1,{symbol('ENV'),{false,scm_nil}}}}},scm_nil}},{{{symbol('p'),scm_nil},{{symbol('repl'),{symbol('p'),{1,{symbol('ENV'),{false,scm_nil}}}}},scm_nil}},{{{symbol('p'),{symbol('i'),scm_nil}},{{symbol('repl'),{symbol('p'),{symbol('i'),{symbol('ENV'),{false,scm_nil}}}}},scm_nil}},{{{symbol('p'),{symbol('i'),{symbol('env'),scm_nil}}},{{symbol('repl'),{symbol('p'),{symbol('i'),{symbol('env'),{false,scm_nil}}}}},scm_nil}},{{{symbol('p'),{symbol('i'),{symbol('env'),{false,scm_nil}}}},{{symbol('repl'),{symbol('p'),{symbol('i'),{symbol('env'),{{symbol('phase'),{{symbol('quote'),{symbol('loading'),scm_nil}},scm_nil}},scm_nil}}}}},scm_nil}},{{{symbol('p'),{symbol('i'),{symbol('env'),{symbol('old'),scm_nil}}}},{{symbol('if'),{symbol('p'),{{symbol('cond'),{{{symbol('eq?'),{symbol('platform'),{"Boot Scheme",scm_nil}}},{{symbol('display'),{"boot> ",scm_nil}},scm_nil}},{{{symbol('eq?'),{symbol('platform'),{"Scheme 51",scm_nil}}},{{symbol('display'),{"> ",scm_nil}},scm_nil}},{{symbol('else'),{{symbol('display'),{"load> ",scm_nil}},scm_nil}},scm_nil}}}},scm_nil}}},{{symbol('let'),{{{symbol('x'),{{symbol('read'),scm_nil},scm_nil}},scm_nil},{{symbol('if'),{{symbol('eq?'),{symbol('x'),{scm_eof,scm_nil}}},{{symbol('phase'),{symbol('old'),scm_nil}},{{symbol('begin'),{{symbol('catch'),{{symbol('lambda'),{scm_nil,{{{symbol('if'),{symbol('p'),{symbol('write'),{{symbol('lambda'),{{symbol('x'),scm_nil},{false,scm_nil}}},scm_nil}}}},{{symbol('compile-and-run'),{symbol('x'),{symbol('env'),scm_nil}}},scm_nil}},{{symbol('if'),{symbol('p'),{{symbol('newline'),scm_nil},scm_nil}}},scm_nil}}}},{{symbol('lambda'),{{symbol('e'),scm_nil},{{symbol('display'),{"Error in user code: ",{symbol('e'),{"\
",scm_nil}}}},scm_nil}}},scm_nil}}},{{symbol('repl'),{symbol('p'),{{symbol('+'),{1,{symbol('i'),scm_nil}}},{symbol('env'),{symbol('old'),scm_nil}}}}},scm_nil}}},scm_nil}}}},scm_nil}}},scm_nil}}},scm_nil}}}}}} )
 ...
 end)(var(_S35S461679, "#.1679") )
 end);
 ignore(_repl)_S42loadedS45modulesS42 = scm_nil;
 ignore(_S42loadedS45modulesS42)_compileS45file = (function(_path  )
 local _loop;
 _loop = (function()
 (function(_S35S461725)
 if _S35S461725 then
 term.clearLine()
 term.write("sleeping")
 return _callS47native({symbol('sleep'),scm_nil},  0.2 ) else
 return true
 end
 end)(var(_hashS45ref, "hash-ref")(var(_environment, "environment")(),  "term" ));
 return (function(_x  )
 ...
 return (function(_S35S461724  )
 _phase(var(_S35S461723, "#.1723") );
 return var(_S35S461724, "#.1724")
 end)((function()
 ...
 local _S35S461727 = list(...);
 return (function(_S35S461728  )
 return (function(_S35S461729  )
 if _caseS45pairS63(var(_S35S461728, "#.1728") ) then return (function(_e  )
 if _S61(scm_nil,  (_S35S461728)[2] ) then return (function()
 return _compileS45andS45run(var(_e, "e"),  var(_ENV, "ENV") )
 end)() else return var(_S35S461729, "#.1729")() end
 end)((_S35S461728)[1] ) else return var(_S35S461729, "#.1729")() end
 end)((function()
 return (function(_S35S461730  )
 if _caseS45pairS63(var(_S35S461728, "#.1728") ) then return (function(_e  )
 return (function(_S35S461731  )
 if _caseS45pairS63((_S35S461728)[2] ) then return (function(_env  )
 if _S61(scm_nil,  ((_S35S461728)[2])[2] ) then return (function()
 return _compileS45andS45run(var(_e, "e"),  var(_env, "env") )
 end)() else return var(_S35S461731, "#.1731")() end
 end)(((_S35S461728)[2])[1] ) else return var(_S35S461731, "#.1731")() end
 end)((function()
 return var(_S35S461730, "#.1730")()
 end) )
 end)((_S35S461728)[1] ) else return var(_S35S461730, "#.1730")() end
 end)((function()
 return var(_error, "error")("no matching case for ",  var(_S35S461727, "#.1727"),  " in ",  {{{symbol('e'),scm_nil},{{symbol('compile-and-run'),{symbol('e'),{symbol('ENV'),scm_nil}}},scm_nil}},{{{symbol('e'),{symbol('env'),scm_nil}},{{symbol('compile-and-run'),{symbol('e'),{symbol('env'),scm_nil}}},scm_nil}},scm_nil}} )
 end) )
 end) )
 end)(var(_S35S461727, "#.1727") )
 end);
 ignore(_eval)_load = (function(...)
 local _S35S461737 = list(...);
 return (function(_S35S461738  )
 return (function(_S35S461739  )
 if _caseS45pairS63(var(_S35S461738, "#.1738") ) then return (function(_path  )
 if _S61(scm_nil,  (_S35S461738)[2] ) then return (function()
 ...
 end)((_S35S461738)[1] ) else return var(_S35S461739, "#.1739")() end
 end)((function()
 return (function(_S35S461740  )
 if _caseS45pairS63(var(_S35S461738, "#.1738") ) then return (function(_path  )
 return (function(_S35S461741  )
 if _caseS45pairS63((_S35S461738)[2] ) then return (function(_env  )
 if _S61(scm_nil,  ((_S35S461738)[2])[2] ) then return (function()
 return var(_withS45inputS45fromS45file, "with-input-from-file")(var(_path, "path"),  (function()
 return _repl(false,  0,  var(_env, "env") )
 end) )
 end)() else return var(_S35S461741, "#.1741")() end
 end)(((_S35S461738)[2])[1] ) else return var(_S35S461741, "#.1741")() end
 end)((function()
 return var(_S35S461740, "#.1740")()
 end) )
 end)((_S35S461738)[1] ) else return var(_S35S461740, "#.1740")() end
 end)((function()
 return var(_error, "error")("no matching case for ",  var(_S35S461737, "#.1737"),  " in ",  {{{symbol('path'),scm_nil},{{symbol('with-input-from-file'),{symbol('path'),{{symbol('lambda'),{scm_nil,{{symbol('repl'),{false,{0,scm_nil}}},scm_nil}}},scm_nil}}},scm_nil}},{{{symbol('path'),{symbol('env'),scm_nil}},{{symbol('with-input-from-file'),{symbol('path'),{{symbol('lambda'),{scm_nil,{{symbol('repl'),{false,{0,{symbol('env'),scm_nil}}}},scm_nil}}},scm_nil}}},scm_nil}},scm_nil}} )
 end) )
 end) )
 end)(var(_S35S461737, "#.1737") )
 end);
 ignore(_load)ignore(_pushS45macroS33(symbol('run/native'),  (function(_S35S461747  )
...
" ) else
 ...
 end)())ignore(_pushS45macroS33(symbol('define/native'),  (function(_S35S461751  )
...
" ) else
 ...
 end)())ignore((function(_S35S461775)
 if _S35S461775 then
 return (function()
 (function(_S35S461776)
 if _S35S461776 then
 return var(_display, "display")("\
",  "_platform = 'Scheme 51'",  "\
" ) else
...
" ) else
 ...
 end)((function(_S35S461772  )
 if var(_S35S461772, "#.1772") then return _S35S461772 else return (function(_S35S461773  )
 if var(_S35S461773, "#.1773") then return _S35S461773 else return false end
...
" ) else
 ...
 if _S61(scm_nil,  var(_S35S461785, "#.1785") ) then return (function()
 return var(_error, "error")("empty path" )
 end)() else return (function(_S35S461786  )
 return (function(_S35S461789  )
 if _caseS45pairS63(_S35S461785 ) then return (function(_x  )
 if _S61(scm_nil,  (_S35S461785)[2] ) then if var(_symbolS63, "symbol?")(var(_x, "x") ) then return (function()
 return _compilerS45format("%s.ss",  (_x)[1] )
 end)() else return var(_S35S461786, "#.1786")() end else return var(_S35S461789, "#.1789")() end
 end)((_S35S461785)[1] ) else return var(_S35S461789, "#.1789")() end
 end)((function()
 return var(_S35S461786, "#.1786")()
 end) )
 end)((function()
 return (function(_S35S461787  )
 return (function(_S35S461788  )
 if _caseS45pairS63(_S35S461785 ) then return (function(_a  )
 return (function(_b  )
 if var(_symbolS63, "symbol?")(var(_a, "a") ) then return (function()
 return _compilerS45format("%s/%s",  (_a)[1],  _pathS45S62string(var(_b, "b") ) )
 end)() else return var(_S35S461787, "#.1787")() end
 end)((_S35S461785)[2] )
 end)((_S35S461785)[1] ) else return var(_S35S461788, "#.1788")() end
 end)((function()
 return var(_S35S461787, "#.1787")()
 end) )
 end)((function()
 return false
 end) )
 ...
 ignore(_dofile)_doS45loadS45module = (function(_S35S461796)
 if _S35S461796 then
 return (function(_path ,  _env  )
 (function(_S35S461797)
 if _S35S461797 then
 return false else
 return (function()
 ...
 ignore(_doS45loadS45module)_loadS45mod = (function(_S35S461812)
 if _S35S461812 then
 return (function(_module ,  _env  )
 local _path;
 _path = _pathS45S62string(var(_module, "module") );
 (function(_S35S461813)
 if _S35S461813 then
 return false else
 return (function()
 ...
 end)((function(_S35S461803  )
 if var(_S35S461803, "#.1803") then return _S35S461803 else return (function(_S35S461804  )
 if var(_S35S461804, "#.1804") then return _S35S461804 else return false end
 end)(symbol('main') ) end
 end)(_moduleS45name() ) );
 ...
 end)() else return (function(_S35S461807  )
 return (function(_x  )
 ...
 end)() else return var(_S35S461807, "#.1807")() end
 end)(_S35S461806 )
 end)((function()
 return false
 end) ) end end
...
" );
 return (function(_S35S461808  )
 if _S61(symbol('loading'),  var(_S35S461808, "#.1808") ) then return (function()
 return var(_error, "error")("Cycle in module dependency graph: ",  _module,  " is already being loaded" )
 end)() else if _S61(false,  _S35S461808 ) then return (function()
 _hashS45setS33(_loadedS45modules(),  _path,  symbol('loading') );
 (function(_name  )
 _moduleS45name(_module );
 _load(_path,  var(_env, "env") );
 return _moduleS45name(var(_name, "name") )
 end)((function(_S35S461809  )
 if var(_S35S461809, "#.1809") then return _S35S461809 else return (function(_S35S461810  )
 if var(_S35S461810, "#.1810") then return _S35S461810 else return false end
 end)(symbol('main') ) end
 end)(_moduleS45name() ) );
 _hashS45setS33(_loadedS45modules(),  _path,  false );
 return true
 end)() else if _S61(true,  _S35S461808 ) then return (function()
 return true
 end)() else return false end end end
 end)(_hashS45ref(_loadedS45modules(),  _path ) )
 end)
 ...
 ignore(_loadS45mod)ignore(_pushS45macroS33(symbol('use-module'),  (function(_S35S461825  )
 ...
 end),  var(_S35S461825, "#.1825") )
 end) ))ignore(_pushS45macroS33(symbol('use-modules'),  (function(_S35S461826  )
 return var(_apply, "apply")((function(...)
 local _mods = list(...);
